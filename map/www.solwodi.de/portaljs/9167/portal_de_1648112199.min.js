...
else{t(e)}})(typeof window!=='undefined'?window:this,function(e,n){'use strict';var v=[],We=Object.getPrototypeOf,y=v.slice,Ue=v.flat?function(e){return v.flat.call(e)}:function(e){return v.concat.apply([],e)},oe=v.push,V=v.indexOf,G={};var Pe=G.toString,Y=G.hasOwnProperty,Be=Y.toString,Vt=Be.call(Object),a={};var r=function(e){return typeof e==='function'&&typeof e.nodeType!=='number'&&typeof e.item!=='function'},S=function(e){return e!=null&&e===e.window},o=e.document,Yt={type:!0,src:!0,nonce:!0,noModule:!0};function Ye(e,t,n){n=n||o;var i,a,r=n.createElement('script');r.text=e;if(t){for(i in Yt){a=t[i]||t.getAttribute&&t.getAttribute(i);if(a){r.setAttribute(i,a)}}};n.head.appendChild(r).parentNode.removeChild(r)};function F(e){if(e==null){return e+''};return typeof e==='object'||typeof e==='function'?G[Pe.call(e)]||'object':typeof e};var Re='3.6.0',t=function(e,n){return new t.fn.init(e,n)};t.fn=t.prototype={jquery:Re,constructor:t,length:0,toArray:function(){return y.call(this)},get:function(e){if(e==null){return y.call(this)};return e<0?this[e+this.length]:this[e]},pushStack:function(e){var n=t.merge(this.constructor(),e);n.prevObject=this;return n},each:function(e){return t.each(this,e)},map:function(e){return this.pushStack(t.map(this,function(t,n){return e.call(t,n,t)}))},slice:function(){return this.pushStack(y.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},even:function(){return this.pushStack(t.grep(this,function(e,t){return(t+1)%2}))},odd:function(){return this.pushStack(t.grep(this,function(e,t){return t%2}))},eq:function(e){var n=this.length,t=+e+(e<0?n:0);return this.pushStack(t>=0&&t<n?[this[t]]:[])},end:function(){return this.prevObject||this.constructor()},push:oe,sort:v.sort,splice:v.splice};t.extend=t.fn.extend=function(){var u,o,a,n,s,l,e=arguments[0]||{},i=1,f=arguments.length,c=!1;if(typeof e==='boolean'){c=e;e=arguments[i]||{};i++};if(typeof e!=='object'&&!r(e)){e={}};if(i===f){e=this;i--};for(;i<f;i++){if((u=arguments[i])!=null){for(o in u){n=u[o];if(o==='__proto__'||e===n){continue};if(c&&n&&(t.isPlainObject(n)||(s=Array.isArray(n)))){a=e[o];if(s&&!Array.isArray(a)){l=[]}
else if(!s&&!t.isPlainObject(a)){l={}}
else{l=a};s=!1;e[o]=t.extend(c,l,n)}
else if(n!==undefined){e[o]=n}}}};return e};t.extend({expando:'jQuery'+(Re+Math.random()).replace(/\D/g,''),isReady:!0,error:function(e){throw new Error(e)},noop:function(){},isPlainObject:function(e){var t,n;if(!e||Pe.call(e)!=='[object Object]'){return!1};t=We(e);if(!t){return!0};n=Y.call(t,'constructor')&&t.constructor;return typeof n==='function'&&Be.call(n)===Vt},isEmptyObject:function(e){var t;for(t in e){return!1};return!0},globalEval:function(e,t,n){Ye(e,{nonce:t&&t.nonce},n)},each:function(e,t){var i,n=0;if(ae(e)){i=e.length;for(;n<i;n++){if(t.call(e[n],n,e[n])===!1){break}}}
 ...
 * Date: 2021-02-16
 */
(function(e){var D,o,t,A,K,F,P,Q,N,v,S,y,n,u,c,s,w,H,E,a='sizzle'+1*new Date(),f=e.document,h=0,de=0,ee=L(),te=L(),ne=L(),j=L(),B=function(e,t){if(e===t){S=!0};return 0},pe=({}).hasOwnProperty,x=[],he=x.pop,ge=x.push,b=x.push,ie=x.slice,k=function(e,t){var n=0,i=e.length;for(;n<i;n++){if(e[n]===t){return n}};return-1},W='checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped',i='[\\x20\\t\\r\\n\\f]',T='(?:\\\\[\\da-fA-F]{1,6}'+i+'?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+',re='\\['+i+'*('+T+')(?:'+i+'*([*^$|!~]?=)'+i+'*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|('+T+'))|)'+i+'*\\]',U=':('+T+')(?:\\(((\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|'+re+')*)|.*)\\)|)',me=new RegExp(i+'+','g'),O=new RegExp('^'+i+'+|((?:^|[^\\\\])(?:\\\\.)*)'+i+'+$','g'),ve=new RegExp('^'+i+'*,'+i+'*'),oe=new RegExp('^'+i+'*([>+~]|'+i+')'+i+'*'),ye=new RegExp(i+'|>'),be=new RegExp(U),we=new RegExp('^'+T+'$'),z={'ID':new RegExp('^#('+T+')'),'CLASS':new RegExp('^\\.('+T+')'),'TAG':new RegExp('^('+T+'|[*])'),'ATTR':new RegExp('^'+re),'PSEUDO':new RegExp('^'+U),'CHILD':new RegExp('^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\('+i+'*(even|odd|(([+-]|)(\\d*)n|)'+i+'*(?:([+-]|)'+i+'*(\\d+)|))'+i+'*\\)|)','i'),'bool':new RegExp('^(?:'+W+')$','i'),'needsContext':new RegExp('^'+i+'*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\('+i+'*((?:-\\d)?\\d*)'+i+'*\\)|)(?=[^-]|$)','i')},xe=/HTML$/i,ke=/^(?:input|select|textarea|button)$/i,Te=/^h\d$/i,M=/^[^{]+\{\s*\[native \w/,Ce=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Y=/[+~]/,g=new RegExp('\\\\[\\da-fA-F]{1,6}'+i+'?|\\\\([^\\r\\n\\f])','g'),m=function(e,t){var n='0x'+e.slice(1)-0x10000;return t?t:n<0?String.fromCharCode(n+0x10000):String.fromCharCode(n>>10|0xD800,n&0x3FF|0xDC00)},ae=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,se=function(e,t){if(t){if(e==='\0'){return'\uFFFD'};return e.slice(0,-1)+'\\'+e.charCodeAt(e.length-1).toString(16)+' '};return'\\'+e},le=function(){y()},De=q(function(e){return e.disabled===!0&&e.nodeName.toLowerCase()==='fieldset'},{dir:'parentNode',next:'legend'});try{b.apply((x=ie.call(f.childNodes)),f.childNodes);x[f.childNodes.length].nodeType}catch(l){b={apply:x.length?function(e,t){ge.apply(e,ie.call(t))}:function(e,t){var n=e.length,i=0;while((e[n++]=t[i++])){};e.length=n-1}}};function r(e,t,i,r){var u,m,f,d,v,g,w,h=t&&t.ownerDocument,p=t?t.nodeType:9;i=i||[];if(typeof e!=='string'||!e||p!==1&&p!==9&&p!==11){return i};if(!r){y(t);t=t||n;if(c){if(p!==11&&(v=Ce.exec(e))){if((u=v[1])){if(p===9){if((f=t.getElementById(u))){if(f.id===u){i.push(f);return i}}
else{return i}}
else{if(h&&(f=h.getElementById(u))&&E(t,f)&&f.id===u){i.push(f);return i}}}
...
else if(o.qsa){return t.querySelectorAll(e)}}:function(e,t){var n,i=[],o=0,r=t.getElementsByTagName(e);if(e==='*'){while((n=r[o++])){if(n.nodeType===1){i.push(n)}};return i};return r};t.find['CLASS']=o.getElementsByClassName&&function(e,t){if(typeof t.getElementsByClassName!=='undefined'&&c){return t.getElementsByClassName(e)}};w=[];s=[];if((o.qsa=M.test(n.querySelectorAll))){p(function(e){var t;u.appendChild(e).innerHTML='<a id=\''+a+'\'></a><select id=\''+a+'-\r\\\' msallowcapture=\'\'><option selected=\'\'></option></select>';if(e.querySelectorAll('[msallowcapture^=\'\']').length){s.push('[*^$]='+i+'*(?:\'\'|"")')};if(!e.querySelectorAll('[selected]').length){s.push('\\['+i+'*(?:value|'+W+')')};if(!e.querySelectorAll('[id~='+a+'-]').length){s.push('~=')};t=n.createElement('input');t.setAttribute('name','');e.appendChild(t);if(!e.querySelectorAll('[name=\'\']').length){s.push('\\['+i+'*name'+i+'*='+i+'*(?:\'\'|"")')};if(!e.querySelectorAll(':checked').length){s.push(':checked')};if(!e.querySelectorAll('a#'+a+'+*').length){s.push('.#.+[+~]')};e.querySelectorAll('\\\f');s.push('[\\r\\n\\f]')});p(function(e){e.innerHTML='<a href=\'\' disabled=\'disabled\'></a><select disabled=\'disabled\'><option/></select>';var t=n.createElement('input');t.setAttribute('type','hidden');e.appendChild(t).setAttribute('name','D');if(e.querySelectorAll('[name=d]').length){s.push('name'+i+'*[*^$|!~]?=')};if(e.querySelectorAll(':enabled').length!==2){s.push(':enabled',':disabled')};u.appendChild(e).disabled=!0;if(e.querySelectorAll(':disabled').length!==2){s.push(':enabled',':disabled')};e.querySelectorAll('*,:x');s.push(',.*:')})};if((o.matchesSelector=M.test((H=u.matches||u.webkitMatchesSelector||u.mozMatchesSelector||u.oMatchesSelector||u.msMatchesSelector)))){p(function(e){o.disconnectedMatch=H.call(e,'*');H.call(e,'[s!=\'\']:x');w.push('!=',U)})};s=s.length&&new RegExp(s.join('|'));w=w.length&&new RegExp(w.join('|'));d=M.test(u.compareDocumentPosition);E=d||M.test(u.contains)?function(e,t){var i=e.nodeType===9?e.documentElement:e,n=t&&t.parentNode;return e===n||!!(n&&n.nodeType===1&&(i.contains?i.contains(n):e.compareDocumentPosition&&e.compareDocumentPosition(n)&16))}:function(e,t){if(t){while((t=t.parentNode)){if(t===e){return!0}}};return!1};B=d?function(e,t){if(e===t){S=!0;return 0};var i=!e.compareDocumentPosition-!t.compareDocumentPosition;if(i){return i};i=(e.ownerDocument||e)==(t.ownerDocument||t)?e.compareDocumentPosition(t):1;if(i&1||(!o.sortDetached&&t.compareDocumentPosition(e)===i)){if(e==n||e.ownerDocument==f&&E(f,e)){return-1};if(t==n||t.ownerDocument==f&&E(f,t)){return 1};return v?(k(v,e)-k(v,t)):0};return i&4?-1:1}:function(e,t){if(e===t){S=!0;return 0};var i,r=0,s=e.parentNode,l=t.parentNode,o=[e],a=[t];if(!s||!l){return e==n?-1:t==n?1:s?-1:l?1:v?(k(v,e)-k(v,t)):0}
else if(s===l){return ue(e,t)};i=e;while((i=i.parentNode)){o.unshift(i)};i=t;while((i=i.parentNode)){a.unshift(i)}
while(o[r]===a[r]){r++};return r?ue(o[r],a[r]):o[r]==f?-1:a[r]==f?1:0};return n};r.matches=function(e,t){return r(e,null,null,t)};r.matchesSelector=function(e,t){y(e);if(o.matchesSelector&&c&&!j[t+' ']&&(!w||!w.test(t))&&(!s||!s.test(t))){try{var a=H.call(e,t);if(a||o.disconnectedMatch||e.document&&e.document.nodeType!==11){return a}}catch(i){j(t,!0)}};return r(t,n,null,[e]).length>0};r.contains=function(e,t){if((e.ownerDocument||e)!=n){y(e)};return E(e,t)};r.attr=function(e,i){if((e.ownerDocument||e)!=n){y(e)};var a=t.attrHandle[i.toLowerCase()],r=a&&pe.call(t.attrHandle,i.toLowerCase())?a(e,i,!c):undefined;return r!==undefined?r:o.attributes||!c?e.getAttribute(i):(r=e.getAttributeNode(i))&&r.specified?r.value:null};r.escape=function(e){return(e+'').replace(ae,se)};r.error=function(e){throw new Error('Syntax error, unrecognized expression: '+e)};r.uniqueSort=function(e){var i,r=[],t=0,n=0;S=!o.detectDuplicates;v=!o.sortStable&&e.slice(0);e.sort(B);if(S){while((i=e[n++])){if(i===e[n]){t=r.push(n)}}
while(t--){e.splice(r[t],1)}};v=null;return e};A=r.getText=function(e){var i,n='',r=0,t=e.nodeType;if(!t){while((i=e[r++])){n+=A(i)}}
...
else if(e[3]){r.error(e[0])};return e},'PSEUDO':function(e){var n,t=!e[6]&&e[2];if(z['CHILD'].test(e[0])){return null};if(e[3]){e[2]=e[4]||e[5]||''}
else if(t&&be.test(t)&&(n=F(t,!0))&&(n=t.indexOf(')',t.length-n)-t.length)){e[0]=e[0].slice(0,n);e[2]=t.slice(0,n)};return e.slice(0,3)}},filter:{'TAG':function(e){var t=e.replace(g,m).toLowerCase();return e==='*'?function(){return!0}:function(e){return e.nodeName&&e.nodeName.toLowerCase()===t}},'CLASS':function(e){var t=ee[e+' '];return t||(t=new RegExp('(^|'+i+')'+e+'('+i+'|$)'))&&ee(e,function(e){return t.test(typeof e.className==='string'&&e.className||typeof e.getAttribute!=='undefined'&&e.getAttribute('class')||'')})},'ATTR':function(e,t,n){return function(i){var o=r.attr(i,e);if(o==null){return t==='!='};if(!t){return!0};o+='';return t==='='?o===n:t==='!='?o!==n:t==='^='?n&&o.indexOf(n)===0:t==='*='?n&&o.indexOf(n)>-1:t==='$='?n&&o.slice(-n.length)===n:t==='~='?(' '+o.replace(me,' ')+' ').indexOf(n)>-1:t==='|='?o===n||o.slice(0,n.length+1)===n+'-':!1}},'CHILD':function(e,t,n,i,r){var l=e.slice(0,3)!=='nth',s=e.slice(-4)!=='last',o=t==='of-type';return i===1&&r===0?function(e){return!!e.parentNode}:function(t,n,u){var g,m,p,c,d,v,y=l!==s?'nextSibling':'previousSibling',b=t.parentNode,x=o&&t.nodeName.toLowerCase(),w=!u&&!o,f=!1;if(b){if(l){while(y){c=t;while((c=c[y])){if(o?c.nodeName.toLowerCase()===x:c.nodeType===1){return!1}};v=y=e==='only'&&!v&&'nextSibling'};return!0};v=[s?b.firstChild:b.lastChild];if(s&&w){c=b;p=c[a]||(c[a]={});m=p[c.uniqueID]||(p[c.uniqueID]={});g=m[e]||[];d=g[0]===h&&g[1];f=d&&g[2];c=d&&b.childNodes[d];while((c=++d&&c&&c[y]||(f=d=0)||v.pop())){if(c.nodeType===1&&++f&&c===t){m[e]=[h,d,f];break}}}
else{if(w){c=t;p=c[a]||(c[a]={});m=p[c.uniqueID]||(p[c.uniqueID]={});g=m[e]||[];d=g[0]===h&&g[1];f=d};if(f===!1){while((c=++d&&c&&c[y]||(f=d=0)||v.pop())){if((o?c.nodeName.toLowerCase()===x:c.nodeType===1)&&++f){if(w){p=c[a]||(c[a]={});m=p[c.uniqueID]||(p[c.uniqueID]={});m[e]=[h,f]};if(c===t){break}}}}};f-=r;return f===i||(f%i===0&&f/i>=0)}}},'PSEUDO':function(e,n){var o,i=t.pseudos[e]||t.setFilters[e.toLowerCase()]||r.error('unsupported pseudo: '+e);if(i[a]){return i(n)};if(i.length>1){o=[e,e,'',n];return t.setFilters.hasOwnProperty(e.toLowerCase())?d(function(e,t){var r,o=i(e,n),a=o.length;while(a--){r=k(e,o[a]);e[r]=!(t[r]=o[a])}}):function(e){return i(e,0,o)}};return i}},pseudos:{'not':d(function(e){var t=[],i=[],n=P(e.replace(O,'$1'));return n[a]?d(function(e,t,i,r){var a,s=n(e,null,r,[]),o=e.length;while(o--){if((a=s[o])){e[o]=!(t[o]=a)}}}):function(e,r,o){t[0]=e;n(t,null,o,i);t[0]=null;return!i.pop()}}),'has':d(function(e){return function(t){return r(e,t).length>0}}),'contains':d(function(e){e=e.replace(g,m);return function(t){return(t.textContent||A(t)).indexOf(e)>-1}}),'lang':d(function(e){if(!we.test(e||'')){r.error('unsupported lang: '+e)};e=e.replace(g,m).toLowerCase();return function(t){var n;do{if((n=c?t.lang:t.getAttribute('xml:lang')||t.getAttribute('lang'))){n=n.toLowerCase();return n===e||n.indexOf(e+'-')===0}}
while((t=t.parentNode)&&t.nodeType===1);return!1}}),'target':function(t){var n=e.location&&e.location.hash;return n&&n.slice(1)===t.id},'root':function(e){return e===u},'focus':function(e){return e===n.activeElement&&(!n.hasFocus||n.hasFocus())&&!!(e.type||e.href||~e.tabIndex)},'enabled':ce(!1),'disabled':ce(!0),'checked':function(e){var t=e.nodeName.toLowerCase();return(t==='input'&&!!e.checked)||(t==='option'&&!!e.selected)},'selected':function(e){if(e.parentNode){e.parentNode.selectedIndex};return e.selected===!0},'empty':function(e){for(e=e.firstChild;e;e=e.nextSibling){if(e.nodeType<6){return!1}};return!0},'parent':function(e){return!t.pseudos['empty'](e)},'header':function(e){return Te.test(e.nodeName)},'input':function(e){return ke.test(e.nodeName)},'button':function(e){var t=e.nodeName.toLowerCase();return t==='input'&&e.type==='button'||t==='button'},'text':function(e){var t;return e.nodeName.toLowerCase()==='input'&&e.type==='text'&&((t=e.getAttribute('type'))==null||t.toLowerCase()==='text')},'first':C(function(){return[0]}),'last':C(function(e,t){return[t-1]}),'eq':C(function(e,t,n){return[n<0?n+t:n]}),'even':C(function(e,t){var n=0;for(;n<t;n+=2){e.push(n)};return e}),'odd':C(function(e,t){var n=1;for(;n<t;n+=2){e.push(n)};return e}),'lt':C(function(e,t,n){var i=n<0?n+t:n>t?t:n;for(;--i>=0;){e.push(i)};return e}),'gt':C(function(e,t,n){var i=n<0?n+t:n;for(;++i<t;){e.push(i)};return e})}};t.pseudos['nth']=t.pseudos['eq'];for(D in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0}){t.pseudos[D]=Se(D)};for(D in{submit:!0,reset:!0}){t.pseudos[D]=Fe(D)};function fe(){};fe.prototype=t.filters=t.pseudos;t.setFilters=new fe();F=r.tokenize=function(e,n){var a,o,l,s,i,u,c,f=te[e+' '];if(f){return n?0:f.slice(0)};i=e;u=[];c=t.preFilter;while(i){if(!a||(o=ve.exec(i))){if(o){i=i.slice(o[0].length)||i};u.push((l=[]))};a=!1;if((o=oe.exec(i))){a=o.shift();l.push({value:a,type:o[0].replace(O,' ')});i=i.slice(a.length)};for(s in t.filter){if((o=z[s].exec(i))&&(!c[s]||(o=c[s](o)))){a=o.shift();l.push({value:a,type:s,matches:o});i=i.slice(a.length)}};if(!a){break}};return n?i.length:i?r.error(e):te(e,u).slice(0)};function I(e){var t=0,i=e.length,n='';for(;t<i;t++){n+=e[t].value};return n};function q(e,t,n){var i=t.dir,r=t.next,o=r||i,s=n&&o==='parentNode',l=de++;return t.first?function(t,n,r){while((t=t[i])){if(t.nodeType===1||s){return e(t,n,r)}};return!1}:function(t,n,u){var c,f,d,p=[h,l];if(u){while((t=t[i])){if(t.nodeType===1||s){if(e(t,n,u)){return!0}}}}
...
else{f[o]=p;if((p[2]=e(t,n,u))){return!0}}}}};return!1}};function J(e){return e.length>1?function(t,n,i){var r=e.length;while(r--){if(!e[r](t,n,i)){return!1}};return!0}:e[0]};function Ee(e,t,n){var i=0,o=t.length;for(;i<o;i++){r(e,t[i],n)};return n};function R(e,t,n,i,r){var a,s=[],o=0,l=e.length,u=t!=null;for(;o<l;o++){if((a=e[o])){if(!n||n(a,i,r)){s.push(a);if(u){t.push(o)}}}};return s};function X(e,t,n,i,r,o){if(i&&!i[a]){i=X(i)};if(r&&!r[a]){r=X(r,o)};return d(function(o,a,s,l){var f,c,d,g=[],h=[],m=a.length,v=o||Ee(t||'*',s.nodeType?[s]:s,[]),p=e&&(o||!t)?R(v,g,e,s,l):v,u=n?r||(o?e:m||i)?[]:a:p;if(n){n(p,u,s,l)};if(i){f=R(u,h);i(f,[],s,l);c=f.length;while(c--){if((d=f[c])){u[h[c]]=!(p[h[c]]=d)}}};if(o){if(r||e){if(r){f=[];c=u.length;while(c--){if((d=u[c])){f.push((p[c]=d))}};r(null,(u=[]),f,l)};c=u.length;while(c--){if((d=u[c])&&(f=r?k(o,d):g[c])>-1){o[f]=!(a[f]=d)}}}}
else{u=R(u===a?u.splice(m,u.length):u);if(r){r(null,a,u,l)}
else{b.apply(a,u)}}})};function Z(e){var s,r,i,l=e.length,u=t.relative[e[0].type],c=u||t.relative[' '],n=u?1:0,f=q(function(e){return e===s},c,!0),d=q(function(e){return k(s,e)>-1},c,!0),o=[function(e,t,n){var i=(!u&&(n||t!==N))||((s=t).nodeType?f(e,t,n):d(e,t,n));s=null;return i}];for(;n<l;n++){if((r=t.relative[e[n].type])){o=[q(J(o),r)]}
else{r=t.filter[e[n].type].apply(null,e[n].matches);if(r[a]){i=++n;for(;i<l;i++){if(t.relative[e[i].type]){break}};return X(n>1&&J(o),n>1&&I(e.slice(0,n-1).concat({value:e[n-2].type===' '?'*':''})).replace(O,'$1'),r,n<i&&Z(e.slice(n,i)),i<l&&Z((e=e.slice(i))),i<l&&I(e))};o.push(r)}};return J(o)};function Me(e,i){var o=i.length>0,a=e.length>0,s=function(s,l,u,f,d){var p,x,v,w=0,g='0',k=s&&[],m=[],T=N,C=s||a&&t.find['TAG']('*',d),D=(h+=T==null?1:Math.random()||0.1),S=C.length;if(d){N=l==n||l||d};for(;g!==S&&(p=C[g])!=null;g++){if(a&&p){x=0;if(!l&&p.ownerDocument!=n){y(p);u=!c}
while((v=e[x++])){if(v(p,l||n,u)){f.push(p);break}};if(d){h=D}};if(o){if((p=!v&&p)){w--};if(s){k.push(p)}}};w+=g;if(o&&g!==w){x=0;while((v=i[x++])){v(k,m,l,u)};if(s){if(w>0){while(g--){if(!(k[g]||m[g])){m[g]=he.call(f)}}};m=R(m)};b.apply(f,m);if(d&&!s&&m.length>0&&(w+i.length)>1){r.uniqueSort(f)}};if(d){h=D;N=T};return k};return o?d(s):s};P=r.compile=function(e,t){var i,r=[],o=[],n=ne[e+' '];if(!n){if(!t){t=F(e)};i=t.length;while(i--){n=Z(t[i]);if(n[a]){r.push(n)}
else{o.push(n)}};n=ne(e,Me(o,r));n.selector=e};return n};Q=r.select=function(e,n,i,r){var s,o,a,f,d,u=typeof e==='function'&&e,l=!r&&F((e=u.selector||e));i=i||[];if(l.length===1){o=l[0]=l[0].slice(0);if(o.length>2&&(a=o[0]).type==='ID'&&n.nodeType===9&&c&&t.relative[o[1].type]){n=(t.find['ID'](a.matches[0].replace(g,m),n)||[])[0];if(!n){return i}
else if(u){n=n.parentNode};e=e.slice(o.shift().value.length)};s=z['needsContext'].test(e)?0:o.length;while(s--){a=o[s];if(t.relative[(f=a.type)]){break};if((d=t.find[f])){if((r=d(a.matches[0].replace(g,m),Y.test(o[0].type)&&G(n.parentNode)||n))){o.splice(s,1);e=r.length&&I(o);if(!e){b.apply(i,r);return i};break}}}}(u||P(e,l))(r,n,!c,i,!n||Y.test(e)&&G(n.parentNode)||n);return i};o.sortStable=a.split('').sort(B).join('')===a;o.detectDuplicates=!!S;y();o.sortDetached=p(function(e){return e.compareDocumentPosition(n.createElement('fieldset'))&1});if(!p(function(e){e.innerHTML='<a href=\'#\'></a>';return e.firstChild.getAttribute('href')==='#'})){V('type|href|height|width',function(e,t,n){if(!n){return e.getAttribute(t,t.toLowerCase()==='type'?1:2)}})};if(!o.attributes||!p(function(e){e.innerHTML='<input/>';e.firstChild.setAttribute('value','');return e.firstChild.getAttribute('value')===''})){V('value',function(e,t,n){if(!n&&e.nodeName.toLowerCase()==='input'){return e.defaultValue}})};if(!p(function(e){return e.getAttribute('disabled')==null})){V(W,function(e,t,n){var i;if(!n){return e[t]===!0?t.toLowerCase():(i=e.getAttributeNode(t))&&i.specified?i.value:null}})};return r})(e);t.find=w;t.expr=w.selectors;t.expr[':']=t.expr.pseudos;t.uniqueSort=t.unique=w.uniqueSort;t.text=w.getText;t.isXMLDoc=w.isXML;t.contains=w.contains;t.escapeSelector=w.escape;var D=function(e,n,i){var r=[],o=i!==undefined;while((e=e[n])&&e.nodeType!==9){if(e.nodeType===1){if(o&&t(e).is(i)){break};r.push(e)}};return r},Ie=function(e,t){var n=[];for(;e;e=e.nextSibling){if(e.nodeType===1&&e!==t){n.push(e)}};return n},qe=t.expr.match.needsContext;function f(e,t){return e.nodeName&&e.nodeName.toLowerCase()===t.toLowerCase()};var Le=(/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i);function se(e,n,i){if(r(n)){return t.grep(e,function(e,t){return!!n.call(e,t,e)!==i})};if(n.nodeType){return t.grep(e,function(e){return(e===n)!==i})};if(typeof n!=='string'){return t.grep(e,function(e){return(V.call(n,e)>-1)!==i})};return t.filter(n,e,i)};t.filter=function(e,n,i){var r=n[0];if(i){e=':not('+e+')'};if(n.length===1&&r.nodeType===1){return t.find.matchesSelector(r,e)?[r]:[]};return t.find.matches(e,t.grep(n,function(e){return e.nodeType===1}))};t.fn.extend({find:function(e){var n,i,r=this.length,o=this;if(typeof e!=='string'){return this.pushStack(t(e).filter(function(){for(n=0;n<r;n++){if(t.contains(o[n],this)){return!0}}}))};i=this.pushStack([]);for(n=0;n<r;n++){t.find(e,o[n],i)};return r>1?t.uniqueSort(i):i},filter:function(e){return this.pushStack(se(this,e||[],!1))},not:function(e){return this.pushStack(se(this,e||[],!0))},is:function(e){return!!se(this,typeof e==='string'&&qe.test(e)?t(e):e||[],!1).length}});var ze,Wt=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,Ut=t.fn.init=function(e,n,i){var a,s;if(!e){return this};i=i||ze;if(typeof e==='string'){if(e[0]==='<'&&e[e.length-1]==='>'&&e.length>=3){a=[null,e,null]}
else{a=Wt.exec(e)};if(a&&(a[1]||!n)){if(a[1]){n=n instanceof t?n[0]:n;t.merge(this,t.parseHTML(a[1],n&&n.nodeType?n.ownerDocument||n:o,!0));if(Le.test(a[1])&&t.isPlainObject(n)){for(a in n){if(r(this[a])){this[a](n[a])}
...
else if(i&&i.length&&F(i)!=='string'){o(i)}})})(arguments);if(i&&!s){f()}};return this},remove:function(){t.each(arguments,function(e,i){var r;while((r=t.inArray(i,n,r))>-1){n.splice(r,1);if(r<=a){a--}}});return this},has:function(e){return e?t.inArray(e,n)>-1:n.length>0},empty:function(){if(n){n=[]};return this},disable:function(){o=l=[];n=i='';return this},disabled:function(){return!n},lock:function(){o=l=[];if(!i&&!s){n=i=''};return this},locked:function(){return!!o},fireWith:function(e,t){if(!o){t=t||[];t=[e,t.slice?t.slice():t];l.push(t);if(!s){f()}};return this},fire:function(){u.fireWith(this,arguments);return this},fired:function(){return!!c}};return u};function E(e){return e};function J(e){throw e};function Ge(e,t,n,i){var a;try{if(e&&r((a=e.promise))){a.call(e).done(t).fail(n)}
...
else{n[o[0]+'With'](this,a?[e]:arguments)}})});e=null}).promise()},then:function(n,i,a){var s=0;function l(n,i,o,a){return function(){var u=this,c=arguments,d=function(){var e,t;if(n<s){return};e=o.apply(u,c);if(e===i.promise()){throw new TypeError('Thenable self-resolution')};t=e&&(typeof e==='object'||typeof e==='function')&&e.then;if(r(t)){if(a){t.call(e,l(s,i,E,a),l(s,i,J,a))}
else{s++;t.call(e,l(s,i,E,a),l(s,i,J,a),l(s,i,E,i.notifyWith))}}
else{if(o!==E){u=undefined;c=[e]}(a||i.resolveWith)(u,c)}},f=a?d:function(){try{d()}catch(e){if(t.Deferred.exceptionHook){t.Deferred.exceptionHook(e,f.stackTrace)};if(n+1>=s){if(o!==J){u=undefined;c=[e]};i.rejectWith(u,c)}}};if(n){f()}
else{if(t.Deferred.getStackHook){f.stackTrace=t.Deferred.getStackHook()};e.setTimeout(f)}}};return t.Deferred(function(e){o[0][3].add(l(0,e,r(a)?a:E,e.notifyWith));o[1][3].add(l(0,e,r(n)?n:E));o[2][3].add(l(0,e,r(i)?i:J))}).promise()},promise:function(e){return e!=null?t.extend(e,a):a}},i={};t.each(o,function(e,t){var n=t[2],r=t[5];a[t[1]]=n.add;if(r){n.add(function(){s=r},o[3-e][2].disable,o[3-e][3].disable,o[0][2].lock,o[0][3].lock)};n.add(t[3].fire);i[t[0]]=function(){i[t[0]+'With'](this===i?undefined:this,arguments);return this};i[t[0]+'With']=n.fireWith});a.promise(i);if(n){n.call(i,i)};return i},when:function(e){var a=arguments.length,n=a,s=Array(n),o=y.call(arguments),i=t.Deferred(),l=function(e){return function(t){s[e]=this;o[e]=arguments.length>1?y.call(arguments):t;if(!(--a)){i.resolveWith(s,o)}}};if(a<=1){Ge(e,i.done(l(n)).resolve,i.reject,!a);if(i.state()==='pending'||r(o[n]&&o[n].then)){return i.then()}}
while(n--){Ge(o[n],l(n),i.reject)};return i.promise()}});var Rt=/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;t.Deferred.exceptionHook=function(t,n){if(e.console&&e.console.warn&&t&&Rt.test(t.name)){e.console.warn('jQuery.Deferred exception: '+t.message,t.stack,n)}};t.readyException=function(t){e.setTimeout(function(){throw t})};var re=t.Deferred();t.fn.ready=function(e){re.then(e).catch(function(e){t.readyException(e)});return this};t.extend({isReady:!1,readyWait:1,ready:function(e){if(e===!0?--t.readyWait:t.isReady){return};t.isReady=!0;if(e!==!0&&--t.readyWait>0){return};re.resolveWith(o,[t])}});t.ready.then=re.then;function X(){o.removeEventListener('DOMContentLoaded',X);e.removeEventListener('load',X);t.ready()};if(o.readyState==='complete'||(o.readyState!=='loading'&&!o.documentElement.doScroll)){e.setTimeout(t.ready)}
else{o.addEventListener('DOMContentLoaded',X);e.addEventListener('load',X)};var m=function(e,n,i,o,a,l,u){var s=0,f=e.length,c=i==null;if(F(i)==='object'){a=!0;for(s in i){m(e,n,s,i[s],!0,l,u)}}
else if(o!==undefined){a=!0;if(!r(o)){u=!0};if(c){if(u){n.call(e,o);n=null}
else{c=n;n=function(e,n,i){return c.call(t(e),i)}}};if(n){for(;s<f;s++){n(e[s],i,u?o:o.call(e[s],s,n(e[s],i)))}}};if(a){return e};if(c){return n.call(e)};return f?n(e[0],i):l},It=/^-ms-/,qt=/-([a-z])/g;function Jt(e,t){return t.toUpperCase()};function h(e){return e.replace(It,'ms-').replace(qt,Jt)};var q=function(e){return e.nodeType===1||e.nodeType===9||!(+e.nodeType)};function R(){this.expando=t.expando+R.uid++};R.uid=1;R.prototype={cache:function(e){var t=e[this.expando];if(!t){t={};if(q(e)){if(e.nodeType){e[this.expando]=t}
...
else{delete e[this.expando]}}},hasData:function(e){var n=e[this.expando];return n!==undefined&&!t.isEmptyObject(n)}};var i=new R(),s=new R(),zt=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Lt=/[A-Z]/g;function Xt(e){if(e==='true'){return!0};if(e==='false'){return!1};if(e==='null'){return null};if(e===+e+''){return+e};if(zt.test(e)){return JSON.parse(e)};return e};function Je(e,t,n){var r;if(n===undefined&&e.nodeType===1){r='data-'+t.replace(Lt,'-$&').toLowerCase();n=e.getAttribute(r);if(typeof n==='string'){try{n=Xt(n)}catch(i){};s.set(e,t,n)}
...
else{o.push(r)}};return o||[]}},dequeue:function(e,n){n=n||'fx';var i=t.queue(e,n),a=i.length,r=i.shift(),o=t._queueHooks(e,n),s=function(){t.dequeue(e,n)};if(r==='inprogress'){r=i.shift();a--};if(r){if(n==='fx'){i.unshift('inprogress')};delete o.stop;r.call(e,s,o)};if(!a&&o){o.empty.fire()}},_queueHooks:function(e,n){var r=n+'queueHooks';return i.get(e,r)||i.access(e,r,{empty:t.Callbacks('once memory').add(function(){i.remove(e,[n+'queue',r])})})}});t.fn.extend({queue:function(e,n){var i=2;if(typeof e!=='string'){n=e;e='fx';i--};if(arguments.length<i){return t.queue(this[0],e)};return n===undefined?this:this.each(function(){var i=t.queue(this,e,n);t._queueHooks(this,e);if(e==='fx'&&i[0]!=='inprogress'){t.dequeue(this,e)}})},dequeue:function(e){return this.each(function(){t.dequeue(this,e)})},clearQueue:function(e){return this.queue(e||'fx',[])},promise:function(e,n){var r,a=1,s=t.Deferred(),o=this,l=this.length,u=function(){if(!(--a)){s.resolveWith(o,[o])}};if(typeof e!=='string'){n=e;e=undefined};e=e||'fx';while(l--){r=i.get(o[l],e+'queueHooks');if(r&&r.empty){a++;r.empty.add(u)}};u();return s.promise(n)}});var Oe=(/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/).source,I=new RegExp('^(?:([+-])=|)('+Oe+')([a-z%]*)$','i'),g=['Top','Right','Bottom','Left'],b=o.documentElement,C=function(e){return t.contains(e.ownerDocument,e)},Ot={composed:!0};if(b.getRootNode){C=function(e){return t.contains(e.ownerDocument,e)||e.getRootNode(Ot)===e.ownerDocument}};var U=function(e,n){e=n||e;return e.style.display==='none'||e.style.display===''&&C(e)&&t.css(e,'display')==='none'};function Xe(e,n,i,r){var l,u,c=20,f=r?function(){return r.cur()}:function(){return t.css(e,n,'')},s=f(),a=i&&i[3]||(t.cssNumber[n]?'':'px'),o=e.nodeType&&(t.cssNumber[n]||a!=='px'&&+s)&&I.exec(t.css(e,n));if(o&&o[3]!==a){s=s/2;a=a||o[3];o=+s||1;while(c--){t.style(e,n,o+a);if((1-u)*(1-(u=f()/s||0.5))<=0){c=0};o=o/u};o=o*2;t.style(e,n,o+a);i=i||[]};if(i){o=+o||+s||0;l=i[1]?o+(i[1]+1)*i[2]:+i[2];if(r){r.unit=a;r.start=o;r.end=l}};return l};var je={};function Zt(e){var i,o=e.ownerDocument,r=e.nodeName,n=je[r];if(n){return n};i=o.body.appendChild(o.createElement(r));n=t.css(i,'display');i.parentNode.removeChild(i);if(n==='none'){n='block'};je[r]=n;return n};function M(e,t){var a,r,o=[],n=0,s=e.length;for(;n<s;n++){r=e[n];if(!r.style){continue};a=r.style.display;if(t){if(a==='none'){o[n]=i.get(r,'display')||null;if(!o[n]){r.style.display=''}};if(r.style.display===''&&U(r)){o[n]=Zt(r)}}
else{if(a!=='none'){o[n]='none';i.set(r,'display',a)}}};for(n=0;n<s;n++){if(o[n]!=null){e[n].style.display=o[n]}};return e};t.fn.extend({show:function(){return M(this,!0)},hide:function(){return M(this)},toggle:function(e){if(typeof e==='boolean'){return e?this.show():this.hide()};return this.each(function(){if(U(this)){t(this).show()}
else{t(this).hide()}})}});var L=(/^(?:checkbox|radio)$/i),Ne=(/<([a-z][^\/\0>\x20\t\r\n\f]*)/i),He=(/^$|^module$|\/(?:java|ecma)script/i);(function(){var n=o.createDocumentFragment(),e=n.appendChild(o.createElement('div')),t=o.createElement('input');t.setAttribute('type','radio');t.setAttribute('checked','checked');t.setAttribute('name','t');e.appendChild(t);a.checkClone=e.cloneNode(!0).cloneNode(!0).lastChild.checked;e.innerHTML='<textarea>x</textarea>';a.noCloneChecked=!!e.cloneNode(!0).lastChild.defaultValue;e.innerHTML='<option></option>';a.option=!!e.lastChild})();var c={thead:[1,'<table>','</table>'],col:[2,'<table><colgroup>','</colgroup></table>'],tr:[2,'<table><tbody>','</tbody></table>'],td:[3,'<table><tbody><tr>','</tr></tbody></table>'],_default:[0,'','']};c.tbody=c.tfoot=c.colgroup=c.caption=c.thead;c.th=c.td;if(!a.option){c.optgroup=c.option=[1,'<select multiple=\'multiple\'>','</select>']};function l(e,n){var i;if(typeof e.getElementsByTagName!=='undefined'){i=e.getElementsByTagName(n||'*')}
else if(typeof e.querySelectorAll!=='undefined'){i=e.querySelectorAll(n||'*')}
else{i=[]};if(n===undefined||n&&f(e,n)){return t.merge([e],i)};return i};function le(e,t){var n=0,r=e.length;for(;n<r;n++){i.set(e[n],'globalEval',!t||i.get(t[n],'globalEval'))}};var jt=/<|&#?\w+;/;function Ze(e,n,i,r,a){var o,s,g,d,m,p,u=n.createDocumentFragment(),h=[],f=0,v=e.length;for(;f<v;f++){o=e[f];if(o||o===0){if(F(o)==='object'){t.merge(h,o.nodeType?[o]:o)}
else if(!jt.test(o)){h.push(n.createTextNode(o))}
else{s=s||u.appendChild(n.createElement('div'));g=(Ne.exec(o)||['',''])[1].toLowerCase();d=c[g]||c._default;s.innerHTML=d[1]+t.htmlPrefilter(o)+d[2];p=d[0];while(p--){s=s.lastChild};t.merge(h,s.childNodes);s=u.firstChild;s.textContent=''}}};u.textContent='';f=0;while((o=h[f++])){if(r&&t.inArray(o,r)>-1){if(a){a.push(o)};continue};m=C(o);s=l(u.appendChild(o),'script');if(m){le(s)};if(i){p=0;while((o=s[p++])){if(He.test(o.type||'')){i.push(o)}}}};return u};var Ae=/^([^.]*)(?:\.(.+)|)/;function A(){return!0};function N(){return!1};function Kt(e,t){return(e===Qt())===(t==='focus')};function Qt(){try{return o.activeElement}catch(e){}};function ue(e,n,i,r,o,a){var s,l;if(typeof n==='object'){if(typeof i!=='string'){r=r||i;i=undefined};for(l in n){ue(e,l,i,r,n[l],a)};return e};if(r==null&&o==null){o=i;r=i=undefined}
else if(o==null){if(typeof i==='string'){o=r;r=undefined}
else{o=r;r=i;i=undefined}};if(o===!1){o=N}
else if(!o){return e};if(a===1){s=o;o=function(e){t().off(e);return s.apply(this,arguments)};o.guid=s.guid||(s.guid=t.guid++)};return e.each(function(){t.event.add(this,n,o,r,i)})};t.event={global:{},add:function(e,n,r,o,a){var f,d,m,h,v,u,l,c,s,y,w,g=i.get(e);if(!q(e)){return};if(r.handler){f=r;r=f.handler;a=f.selector};if(a){t.find.matchesSelector(b,a)};if(!r.guid){r.guid=t.guid++};if(!(h=g.events)){h=g.events=Object.create(null)};if(!(d=g.handle)){d=g.handle=function(n){return typeof t!=='undefined'&&t.event.triggered!==n.type?t.event.dispatch.apply(e,arguments):undefined}};n=(n||'').match(p)||[''];v=n.length;while(v--){m=Ae.exec(n[v])||[];s=w=m[1];y=(m[2]||'').split('.').sort();if(!s){continue};l=t.event.special[s]||{};s=(a?l.delegateType:l.bindType)||s;l=t.event.special[s]||{};u=t.extend({type:s,origType:w,data:o,handler:r,guid:r.guid,selector:a,needsContext:a&&t.expr.match.needsContext.test(a),namespace:y.join('.')},f);if(!(c=h[s])){c=h[s]=[];c.delegateCount=0;if(!l.setup||l.setup.call(e,o,y,d)===!1){if(e.addEventListener){e.addEventListener(s,d)}}};if(l.add){l.add.call(e,u);if(!u.handler.guid){u.handler.guid=r.guid}};if(a){c.splice(c.delegateCount++,0,u)}
else{c.push(u)};t.event.global[s]=!0}},remove:function(e,n,r,o,a){var h,y,u,d,g,l,c,f,s,v,b,m=i.hasData(e)&&i.get(e);if(!m||!(d=m.events)){return};n=(n||'').match(p)||[''];g=n.length;while(g--){u=Ae.exec(n[g])||[];s=b=u[1];v=(u[2]||'').split('.').sort();if(!s){for(s in d){t.event.remove(e,s+n[g],r,o,!0)};continue};c=t.event.special[s]||{};s=(o?c.delegateType:c.bindType)||s;f=d[s]||[];u=u[2]&&new RegExp('(^|\\.)'+v.join('\\.(?:.*\\.|)')+'(\\.|$)');y=h=f.length;while(h--){l=f[h];if((a||b===l.origType)&&(!r||r.guid===l.guid)&&(!u||u.test(l.namespace))&&(!o||o===l.selector||o==='**'&&l.selector)){f.splice(h,1);if(l.selector){f.delegateCount--};if(c.remove){c.remove.call(e,l)}}};if(y&&!f.length){if(!c.teardown||c.teardown.call(e,v,m.handle)===!1){t.removeEvent(e,s,m.handle)};delete d[s]}};if(t.isEmptyObject(d)){i.remove(e,'handle events')}},dispatch:function(e){var r,c,l,a,o,f,u=new Array(arguments.length),n=t.event.fix(e),d=(i.get(this,'events')||Object.create(null))[n.type]||[],s=t.event.special[n.type]||{};u[0]=n;for(r=1;r<arguments.length;r++){u[r]=arguments[r]};n.delegateTarget=this;if(s.preDispatch&&s.preDispatch.call(this,n)===!1){return};f=t.event.handlers.call(this,n,d);r=0;while((a=f[r++])&&!n.isPropagationStopped()){n.currentTarget=a.elem;c=0;while((o=a.handlers[c++])&&!n.isImmediatePropagationStopped()){if(!n.rnamespace||o.namespace===!1||n.rnamespace.test(o.namespace)){n.handleObj=o;n.data=o.data;l=((t.event.special[o.origType]||{}).handle||o.handler).apply(a.elem,u);if(l!==undefined){if((n.result=l)===!1){n.preventDefault();n.stopPropagation()}}}}};if(s.postDispatch){s.postDispatch.call(this,n)};return n.result},handlers:function(e,n){var o,a,r,s,l,c=[],u=n.delegateCount,i=e.target;if(u&&i.nodeType&&!(e.type==='click'&&e.button>=1)){for(;i!==this;i=i.parentNode||this){if(i.nodeType===1&&!(e.type==='click'&&i.disabled===!0)){s=[];l={};for(o=0;o<u;o++){a=n[o];r=a.selector+' ';if(l[r]===undefined){l[r]=a.needsContext?t(r,this).index(i)>-1:t.find(r,this,null,[i]).length};if(l[r]){s.push(a)}};if(s.length){c.push({elem:i,handlers:s})}}}};i=this;if(u<n.length){c.push({elem:i,handlers:n.slice(u)})};return c},addProp:function(e,n){Object.defineProperty(t.Event.prototype,e,{enumerable:!0,configurable:!0,get:r(n)?function(){if(this.originalEvent){return n(this.originalEvent)}}:function(){if(this.originalEvent){return this.originalEvent[e]}},set:function(t){Object.defineProperty(this,e,{enumerable:!0,configurable:!0,writable:!0,value:t})}})},fix:function(e){return e[t.expando]?e:new t.Event(e)},special:{load:{noBubble:!0},click:{setup:function(e){var t=this||e;if(L.test(t.type)&&t.click&&f(t,'input')){Z(t,'click',A)};return!1},trigger:function(e){var t=this||e;if(L.test(t.type)&&t.click&&f(t,'input')){Z(t,'click')};return!0},_default:function(e){var t=e.target;return L.test(t.type)&&t.click&&f(t,'input')&&i.get(t,'click')||f(t,'a')}},beforeunload:{postDispatch:function(e){if(e.result!==undefined&&e.originalEvent){e.originalEvent.returnValue=e.result}}}}};function Z(e,n,r){if(!r){if(i.get(e,n)===undefined){t.event.add(e,n,A)};return};i.set(e,n,!1);t.event.add(e,n,{namespace:!1,handler:function(e){var s,a,o=i.get(this,n);if((e.isTrigger&1)&&this[n]){if(!o.length){o=y.call(arguments);i.set(this,n,o);s=r(this,n);this[n]();a=i.get(this,n);if(o!==a||s){i.set(this,n,!1)}
...
else if(o.length){i.set(this,n,{value:t.event.trigger(t.extend(o[0],t.Event.prototype),o.slice(1),this)});e.stopImmediatePropagation()}}})};t.removeEvent=function(e,t,n){if(e.removeEventListener){e.removeEventListener(t,n)}};t.Event=function(e,n){if(!(this instanceof t.Event)){return new t.Event(e,n)};if(e&&e.type){this.originalEvent=e;this.type=e.type;this.isDefaultPrevented=e.defaultPrevented||e.defaultPrevented===undefined&&e.returnValue===!1?A:N;this.target=(e.target&&e.target.nodeType===3)?e.target.parentNode:e.target;this.currentTarget=e.currentTarget;this.relatedTarget=e.relatedTarget}
else{this.type=e};if(n){t.extend(this,n)};this.timeStamp=e&&e.timeStamp||Date.now();this[t.expando]=!0};t.Event.prototype={constructor:t.Event,isDefaultPrevented:N,isPropagationStopped:N,isImmediatePropagationStopped:N,isSimulated:!1,preventDefault:function(){var e=this.originalEvent;this.isDefaultPrevented=A;if(e&&!this.isSimulated){e.preventDefault()}},stopPropagation:function(){var e=this.originalEvent;this.isPropagationStopped=A;if(e&&!this.isSimulated){e.stopPropagation()}},stopImmediatePropagation:function(){var e=this.originalEvent;this.isImmediatePropagationStopped=A;if(e&&!this.isSimulated){e.stopImmediatePropagation()};this.stopPropagation()}};t.each({altKey:!0,bubbles:!0,cancelable:!0,changedTouches:!0,ctrlKey:!0,detail:!0,eventPhase:!0,metaKey:!0,pageX:!0,pageY:!0,shiftKey:!0,view:!0,'char':!0,code:!0,charCode:!0,key:!0,keyCode:!0,button:!0,buttons:!0,clientX:!0,clientY:!0,offsetX:!0,offsetY:!0,pointerId:!0,pointerType:!0,screenX:!0,screenY:!0,targetTouches:!0,toElement:!0,touches:!0,which:!0},t.event.addProp);t.each({focus:'focusin',blur:'focusout'},function(e,n){t.event.special[e]={setup:function(){Z(this,e,Kt);return!1},trigger:function(){Z(this,e);return!0},_default:function(){return!0},delegateType:n}});t.each({mouseenter:'mouseover',mouseleave:'mouseout',pointerenter:'pointerover',pointerleave:'pointerout'},function(e,n){t.event.special[e]={delegateType:n,bindType:n,handle:function(e){var r,o=this,i=e.relatedTarget,a=e.handleObj;if(!i||(i!==o&&!t.contains(o,i))){e.type=a.origType;r=a.handler.apply(this,arguments);e.type=n};return r}}});t.fn.extend({on:function(e,t,n,i){return ue(this,e,t,n,i)},one:function(e,t,n,i){return ue(this,e,t,n,i,1)},off:function(e,n,i){var r,o;if(e&&e.preventDefault&&e.handleObj){r=e.handleObj;t(e.delegateTarget).off(r.namespace?r.origType+'.'+r.namespace:r.origType,r.selector,r.handler);return this};if(typeof e==='object'){for(o in e){this.off(o,n,e[o])};return this};if(n===!1||typeof n==='function'){i=n;n=undefined};if(i===!1){i=N};return this.each(function(){t.event.remove(this,e,i,n)})}});var At=/<script|<style|<link/i,Nt=/checked\s*(?:[^=]|=\s*.checked.)/i,Ht=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;function Ke(e,n){if(f(e,'table')&&f(n.nodeType!==11?n:n.firstChild,'tr')){return t(e).children('tbody')[0]||e};return e};function en(e){e.type=(e.getAttribute('type')!==null)+'/'+e.type;return e};function tn(e){if((e.type||'').slice(0,5)==='true/'){e.type=e.type.slice(5)}
else{e.removeAttribute('type')};return e};function Qe(e,n){var o,l,a,u,c,f,r;if(n.nodeType!==1){return};if(i.hasData(e)){u=i.get(e);r=u.events;if(r){i.remove(n,'handle events');for(a in r){for(o=0,l=r[a].length;o<l;o++){t.event.add(n,a,r[a][o])}}}};if(s.hasData(e)){c=s.access(e);f=t.extend({},c);s.set(n,f)}};function nn(e,t){var n=t.nodeName.toLowerCase();if(n==='input'&&L.test(e.type)){t.checked=e.checked}
else if(n==='input'||n==='textarea'){t.defaultValue=e.defaultValue}};function H(e,n,o,s){n=Ue(n);var d,v,f,p,u,h,c=0,g=e.length,b=g-1,m=n[0],y=r(m);if(y||(g>1&&typeof m==='string'&&!a.checkClone&&Nt.test(m))){return e.each(function(t){var i=e.eq(t);if(y){n[0]=m.call(this,t,i.html())};H(i,n,o,s)})};if(g){d=Ze(n,e[0].ownerDocument,!1,e,s);v=d.firstChild;if(d.childNodes.length===1){d=v};if(v||s){f=t.map(l(d,'script'),en);p=f.length;for(;c<g;c++){u=d;if(c!==b){u=t.clone(u,!0,!0);if(p){t.merge(f,l(u,'script'))}};o.call(e[c],u,c)};if(p){h=f[f.length-1].ownerDocument;t.map(f,tn);for(c=0;c<p;c++){u=f[c];if(He.test(u.type||'')&&!i.access(u,'globalEval')&&t.contains(h,u)){if(u.src&&(u.type||'').toLowerCase()!=='module'){if(t._evalUrl&&!u.noModule){t._evalUrl(u.src,{nonce:u.nonce||u.getAttribute('nonce')},h)}}
else{Ye(u.textContent.replace(Ht,''),u,h)}}}}}};return e};function et(e,n,i){var r,a=n?t.filter(n,e):e,o=0;for(;(r=a[o])!=null;o++){if(!i&&r.nodeType===1){t.cleanData(l(r))};if(r.parentNode){if(i&&C(r)){le(l(r,'script'))};r.parentNode.removeChild(r)}};return e};t.extend({htmlPrefilter:function(e){return e},clone:function(e,n,i){var r,c,s,o,u=e.cloneNode(!0),f=C(e);if(!a.noCloneChecked&&(e.nodeType===1||e.nodeType===11)&&!t.isXMLDoc(e)){o=l(u);s=l(e);for(r=0,c=s.length;r<c;r++){nn(s[r],o[r])}};if(n){if(i){s=s||l(e);o=o||l(u);for(r=0,c=s.length;r<c;r++){Qe(s[r],o[r])}}
else{Qe(e,u)}};o=l(u,'script');if(o.length>0){le(o,!f&&l(e,'script'))};return u},cleanData:function(e){var r,n,o,l=t.event.special,a=0;for(;(n=e[a])!==undefined;a++){if(q(n)){if((r=n[i.expando])){if(r.events){for(o in r.events){if(l[o]){t.event.remove(n,o)}
else{t.removeEvent(n,o,r.handle)}}};n[i.expando]=undefined};if(n[s.expando]){n[s.expando]=undefined}}}}});t.fn.extend({detach:function(e){return et(this,e,!0)},remove:function(e){return et(this,e)},text:function(e){return m(this,function(e){return e===undefined?t.text(this):this.empty().each(function(){if(this.nodeType===1||this.nodeType===11||this.nodeType===9){this.textContent=e}})},null,e,arguments.length)},append:function(){return H(this,arguments,function(e){if(this.nodeType===1||this.nodeType===11||this.nodeType===9){var t=Ke(this,e);t.appendChild(e)}})},prepend:function(){return H(this,arguments,function(e){if(this.nodeType===1||this.nodeType===11||this.nodeType===9){var t=Ke(this,e);t.insertBefore(e,t.firstChild)}})},before:function(){return H(this,arguments,function(e){if(this.parentNode){this.parentNode.insertBefore(e,this)}})},after:function(){return H(this,arguments,function(e){if(this.parentNode){this.parentNode.insertBefore(e,this.nextSibling)}})},empty:function(){var e,n=0;for(;(e=this[n])!=null;n++){if(e.nodeType===1){t.cleanData(l(e,!1));e.textContent=''}};return this},clone:function(e,n){e=e==null?!1:e;n=n==null?e:n;return this.map(function(){return t.clone(this,e,n)})},html:function(e){return m(this,function(e){var i=this[0]||{},r=0,o=this.length;if(e===undefined&&i.nodeType===1){return i.innerHTML};if(typeof e==='string'&&!At.test(e)&&!c[(Ne.exec(e)||['',''])[1].toLowerCase()]){e=t.htmlPrefilter(e);try{for(;r<o;r++){i=this[r]||{};if(i.nodeType===1){t.cleanData(l(i,!1));i.innerHTML=e}};i=0}catch(n){}};if(i){this.empty().append(e)}},null,e,arguments.length)},replaceWith:function(){var e=[];return H(this,arguments,function(n){var i=this.parentNode;if(t.inArray(this,e)<0){t.cleanData(l(this));if(i){i.replaceChild(n,this)}}},e)}});t.each({appendTo:'append',prependTo:'prepend',insertBefore:'before',insertAfter:'after',replaceAll:'replaceWith'},function(e,n){t.fn[e]=function(e){var r,o=[],a=t(e),s=a.length-1,i=0;for(;i<=s;i++){r=i===s?this:this.clone(!0);t(a[i])[n](r);oe.apply(o,r.get())};return this.pushStack(o)}});var ie=new RegExp('^('+Oe+')(?!px)[a-z%]+$','i'),W=function(t){var n=t.ownerDocument.defaultView;if(!n||!n.opener){n=e};return n.getComputedStyle(t)},Me=function(e,t,n){var r,i,o={};for(i in t){o[i]=e.style[i];e.style[i]=t[i]};r=n.call(e);for(i in t){e.style[i]=o[i]};return r},Mt=new RegExp(g.join('|'),'i');(function(){function i(){if(!n){return};l.style.cssText='position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0';n.style.cssText='position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%';b.appendChild(l).appendChild(n);var t=e.getComputedStyle(n);u=t.top!=='1%';p=r(t.marginLeft)===12;n.style.right='60%';d=r(t.right)===36;c=r(t.width)===36;n.style.position='absolute';f=r(n.offsetWidth/3)===12;b.removeChild(l);n=null};function r(e){return Math.round(parseFloat(e))};var u,c,f,d,s,p,l=o.createElement('div'),n=o.createElement('div');if(!n.style){return};n.style.backgroundClip='content-box';n.cloneNode(!0).style.backgroundClip='';a.clearCloneStyle=n.style.backgroundClip==='content-box';t.extend(a,{boxSizingReliable:function(){i();return c},pixelBoxStyles:function(){i();return d},pixelPosition:function(){i();return u},reliableMarginLeft:function(){i();return p},scrollboxSize:function(){i();return f},reliableTrDimensions:function(){var n,t,i,r;if(s==null){n=o.createElement('table');t=o.createElement('tr');i=o.createElement('div');n.style.cssText='position:absolute;left:-11111px;border-collapse:separate';t.style.cssText='border:1px solid';t.style.height='1px';i.style.height='9px';i.style.display='block';b.appendChild(n).appendChild(t).appendChild(i);r=e.getComputedStyle(t);s=(parseInt(r.height,10)+parseInt(r.borderTopWidth,10)+parseInt(r.borderBottomWidth,10))===t.offsetHeight;b.removeChild(n)};return s}})})();function P(e,n,i){var s,l,u,r,o=e.style;i=i||W(e);if(i){r=i.getPropertyValue(n)||i[n];if(r===''&&!C(e)){r=t.style(e,n)};if(!a.pixelBoxStyles()&&ie.test(r)&&Mt.test(n)){s=o.width;l=o.minWidth;u=o.maxWidth;o.minWidth=o.maxWidth=o.width=r;r=i.width;o.width=s;o.minWidth=l;o.maxWidth=u}};return r!==undefined?r+'':r};function tt(e,t){return{get:function(){if(e()){delete this.get;return};return(this.get=t).apply(this,arguments)}}};var Se=['Webkit','Moz','ms'],Fe=o.createElement('div').style,Ee={};function rn(e){var n=e[0].toUpperCase()+e.slice(1),t=Se.length;while(t--){e=Se[t]+n;if(e in Fe){return e}}};function ce(e){var final=t.cssProps[e]||Ee[e];if(final){return final};if(e in Fe){return e};return Ee[e]=rn(e)||e};var Ft=/^(none|table(?!-c[ea]).+)/,Ce=/^--/,Et={position:'absolute',visibility:'hidden',display:'block'},De={letterSpacing:'0',fontWeight:'400'};function nt(e,t,n){var i=I.exec(t);return i?Math.max(0,i[2]-(n||0))+(i[3]||'px'):t};function fe(e,n,i,r,o,l){var a=n==='width'?1:0,u=0,s=0;if(i===(r?'border':'content')){return 0};for(;a<4;a+=2){if(i==='margin'){s+=t.css(e,i+g[a],!0,o)};if(!r){s+=t.css(e,'padding'+g[a],!0,o);if(i!=='padding'){s+=t.css(e,'border'+g[a]+'Width',!0,o)}
else{u+=t.css(e,'border'+g[a]+'Width',!0,o)}}
else{if(i==='content'){s-=t.css(e,'padding'+g[a],!0,o)};if(i!=='margin'){s-=t.css(e,'border'+g[a]+'Width',!0,o)}}};if(!r&&l>=0){s+=Math.max(0,Math.ceil(e['offset'+n[0].toUpperCase()+n.slice(1)]-l-s-u-0.5))||0};return s};function it(e,n,i){var o=W(e),c=!a.boxSizingReliable()||i,s=c&&t.css(e,'boxSizing',!1,o)==='border-box',l=s,r=P(e,n,o),u='offset'+n[0].toUpperCase()+n.slice(1);if(ie.test(r)){if(!i){return r};r='auto'};if((!a.boxSizingReliable()&&s||!a.reliableTrDimensions()&&f(e,'tr')||r==='auto'||!parseFloat(r)&&t.css(e,'display',!1,o)==='inline')&&e.getClientRects().length){s=t.css(e,'boxSizing',!1,o)==='border-box';l=u in e;if(l){r=e[u]}};r=parseFloat(r)||0;return(r+fe(e,n,i||(s?'border':'content'),l,o,r))+'px'};t.extend({cssHooks:{opacity:{get:function(e,t){if(t){var n=P(e,'opacity');return n===''?'1':n}}}},cssNumber:{'animationIterationCount':!0,'columnCount':!0,'fillOpacity':!0,'flexGrow':!0,'flexShrink':!0,'fontWeight':!0,'gridArea':!0,'gridColumn':!0,'gridColumnEnd':!0,'gridColumnStart':!0,'gridRow':!0,'gridRowEnd':!0,'gridRowStart':!0,'lineHeight':!0,'opacity':!0,'order':!0,'orphans':!0,'widows':!0,'zIndex':!0,'zoom':!0},cssProps:{},style:function(e,n,i,r){if(!e||e.nodeType===3||e.nodeType===8||!e.style){return};var o,l,s,c=h(n),f=Ce.test(n),u=e.style;if(!f){n=ce(c)};s=t.cssHooks[n]||t.cssHooks[c];if(i!==undefined){l=typeof i;if(l==='string'&&(o=I.exec(i))&&o[1]){i=Xe(e,n,o);l='number'};if(i==null||i!==i){return};if(l==='number'&&!f){i+=o&&o[3]||(t.cssNumber[c]?'':'px')};if(!a.clearCloneStyle&&i===''&&n.indexOf('background')===0){u[n]='inherit'};if(!s||!('set' in s)||(i=s.set(e,i,r))!==undefined){if(f){u.setProperty(n,i)}
else{u[n]=i}}}
else{if(s&&'get' in s&&(o=s.get(e,!1,r))!==undefined){return o};return u[n]}},css:function(e,n,i,r){var o,s,a,l=h(n),u=Ce.test(n);if(!u){n=ce(l)};a=t.cssHooks[n]||t.cssHooks[l];if(a&&'get' in a){o=a.get(e,!0,i)};if(o===undefined){o=P(e,n,r)};if(o==='normal'&&n in De){o=De[n]};if(i===''||i){s=parseFloat(o);return i===!0||isFinite(s)?s||0:o};return o}});t.each(['height','width'],function(e,n){t.cssHooks[n]={get:function(e,i,r){if(i){return Ft.test(t.css(e,'display'))&&(!e.getClientRects().length||!e.getBoundingClientRect().width)?Me(e,Et,function(){return it(e,n,r)}):it(e,n,r)}},set:function(e,i,r){var l,o=W(e),u=!a.scrollboxSize()&&o.position==='absolute',f=u||r,c=f&&t.css(e,'boxSizing',!1,o)==='border-box',s=r?fe(e,n,r,c,o):0;if(c&&u){s-=Math.ceil(e['offset'+n[0].toUpperCase()+n.slice(1)]-parseFloat(o[n])-fe(e,n,'border',!1,o)-0.5)};if(s&&(l=I.exec(i))&&(l[3]||'px')!=='px'){e.style[n]=i;i=t.css(e,n)};return nt(e,i,s)}}});t.cssHooks.marginLeft=tt(a.reliableMarginLeft,function(e,t){if(t){return(parseFloat(P(e,'marginLeft'))||e.getBoundingClientRect().left-Me(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+'px'}});t.each({margin:'',padding:'',border:'Width'},function(e,n){t.cssHooks[e+n]={expand:function(t){var i=0,o={},r=typeof t==='string'?t.split(' '):[t];for(;i<4;i++){o[e+g[i]+n]=r[i]||r[i-2]||r[0]};return o}};if(e!=='margin'){t.cssHooks[e+n].set=nt}});t.fn.extend({css:function(e,n){return m(this,function(e,n,i){var o,a,s={},r=0;if(Array.isArray(n)){o=W(e);a=n.length;for(;r<a;r++){s[n[r]]=t.css(e,n[r],!1,o)};return s};return i!==undefined?t.style(e,n,i):t.css(e,n)},e,n,arguments.length>1)}});function u(e,t,n,i,r){return new u.prototype.init(e,t,n,i,r)};t.Tween=u;u.prototype={constructor:u,init:function(e,n,i,r,o,a){this.elem=e;this.prop=i;this.easing=o||t.easing._default;this.options=n;this.start=this.now=this.cur();this.end=r;this.unit=a||(t.cssNumber[i]?'':'px')},cur:function(){var e=u.propHooks[this.prop];return e&&e.get?e.get(this):u.propHooks._default.get(this)},run:function(e){var n,i=u.propHooks[this.prop];if(this.options.duration){this.pos=n=t.easing[this.easing](e,this.options.duration*e,0,1,this.options.duration)}
...
else{e.setTimeout(de,t.fx.interval)};t.fx.tick()}};function rt(){e.setTimeout(function(){T=undefined});return(T=Date.now())};function K(e,t){var i,r=0,n={height:e};t=t?1:0;for(;r<4;r+=2-t){i=g[r];n['margin'+i]=n['padding'+i]=e};if(t){n.opacity=n.width=e};return n};function ot(e,t,n){var r,o=(d.tweeners[t]||[]).concat(d.tweeners['*']),i=0,a=o.length;for(;i<a;i++){if((r=o[i].call(n,t,e))){return r}}};function on(e,n,r){var o,h,m,c,v,l,s,f,y='width' in n||'height' in n,p=this,g={},u=e.style,d=e.nodeType&&U(e),a=i.get(e,'fxshow');if(!r.queue){c=t._queueHooks(e,'fx');if(c.unqueued==null){c.unqueued=0;v=c.empty.fire;c.empty.fire=function(){if(!c.unqueued){v()}}};c.unqueued++;p.always(function(){p.always(function(){c.unqueued--;if(!t.queue(e,'fx').length){c.empty.fire()}})})};for(o in n){h=n[o];if(Dt.test(h)){delete n[o];m=m||h==='toggle';if(h===(d?'hide':'show')){if(h==='show'&&a&&a[o]!==undefined){d=!0}
else{continue}};g[o]=a&&a[o]||t.style(e,o)}};l=!t.isEmptyObject(n);if(!l&&t.isEmptyObject(g)){return};if(y&&e.nodeType===1){r.overflow=[u.overflow,u.overflowX,u.overflowY];s=a&&a.display;if(s==null){s=i.get(e,'display')};f=t.css(e,'display');if(f==='none'){if(s){f=s}
else{M([e],!0);s=e.style.display||s;f=t.css(e,'display');M([e])}};if(f==='inline'||f==='inline-block'&&s!=null){if(t.css(e,'float')==='none'){if(!l){p.done(function(){u.display=s});if(s==null){f=u.display;s=f==='none'?'':f}};u.display='inline-block'}}};if(r.overflow){u.overflow='hidden';p.always(function(){u.overflow=r.overflow[0];u.overflowX=r.overflow[1];u.overflowY=r.overflow[2]})};l=!1;for(o in g){if(!l){if(a){if('hidden' in a){d=a.hidden}}
else{a=i.access(e,'fxshow',{display:s})};if(m){a.hidden=!d};if(d){M([e],!0)};p.done(function(){if(!d){M([e])};i.remove(e,'fxshow');for(o in g){t.style(e,o,g[o])}})};l=ot(d?a[o]:0,o,p);if(!(o in a)){a[o]=l.start;if(d){l.end=l.start;l.start=0}}}};function an(e,n){var i,o,a,r,s;for(i in e){o=h(i);a=n[o];r=e[i];if(Array.isArray(r)){a=r[1];r=e[i]=r[0]};if(i!==o){e[o]=r;delete e[i]};s=t.cssHooks[o];if(s&&'expand' in s){r=s.expand(r);delete e[o];for(i in r){if(!(i in e)){e[i]=r[i];n[i]=a}}}
else{n[o]=a}}};function d(e,n,i){var s,l,u=0,p=d.prefilters.length,a=t.Deferred().always(function(){delete f.elem}),f=function(){if(l){return!1};var s=T||rt(),t=Math.max(0,o.startTime+o.duration-s),u=t/o.duration||0,n=1-u,i=0,r=o.tweens.length;for(;i<r;i++){o.tweens[i].run(n)};a.notifyWith(e,[o,n,t]);if(n<1&&r){return t};if(!r){a.notifyWith(e,[o,1,0])};a.resolveWith(e,[o]);return!1},o=a.promise({elem:e,props:t.extend({},n),opts:t.extend(!0,{specialEasing:{},easing:t.easing._default},i),originalProperties:n,originalOptions:i,startTime:T||rt(),duration:i.duration,tweens:[],createTween:function(n,i){var r=t.Tween(e,o.opts,n,i,o.opts.specialEasing[n]||o.opts.easing);o.tweens.push(r);return r},stop:function(t){var n=0,i=t?o.tweens.length:0;if(l){return this};l=!0;for(;n<i;n++){o.tweens[n].run(1)};if(t){a.notifyWith(e,[o,1,0]);a.resolveWith(e,[o,t])}
else{a.rejectWith(e,[o,t])};return this}}),c=o.props;an(c,o.opts.specialEasing);for(;u<p;u++){s=d.prefilters[u].call(o,e,c,o.opts);if(s){if(r(s.stop)){t._queueHooks(o.elem,o.opts.queue).stop=s.stop.bind(s)};return s}};t.map(c,ot,o);if(r(o.opts.start)){o.opts.start.call(e,o)};o.progress(o.opts.progress).done(o.opts.done,o.opts.complete).fail(o.opts.fail).always(o.opts.always);t.fx.timer(t.extend(f,{elem:e,anim:o,queue:o.opts.queue}));return o};t.Animation=t.extend(d,{tweeners:{'*':[function(e,t){var n=this.createTween(e,t);Xe(n.elem,e,I.exec(t),n);return n}]},tweener:function(e,t){if(r(e)){t=e;e=['*']}
...
else{i=o?r:0};for(;i<u;i++){n=s[i];if((n.selected||i===r)&&!n.disabled&&(!n.parentNode.disabled||!f(n.parentNode,'optgroup'))){a=t(n).val();if(o){return a};l.push(a)}};return l},set:function(e,n){var r,i,o=e.options,a=t.makeArray(n),s=o.length;while(s--){i=o[s];if(i.selected=t.inArray(t.valHooks.option.get(i),a)>-1){r=!0}};if(!r){e.selectedIndex=-1};return a}}}});t.each(['radio','checkbox'],function(){t.valHooks[this]={set:function(e,n){if(Array.isArray(n)){return(e.checked=t.inArray(t(e).val(),n)>-1)}}};if(!a.checkOn){t.valHooks[this].get=function(e){return e.getAttribute('value')===null?'on':e.value}}});a.focusin='onfocusin' in e;var xe=/^(?:focusinfocus|focusoutblur)$/,ke=function(e){e.stopPropagation()};t.extend(t.event,{trigger:function(n,a,s,l){var y,c,f,b,p,h,d,m,v=[s||o],u=Y.call(n,'type')?n.type:n,g=Y.call(n,'namespace')?n.namespace.split('.'):[];c=m=f=s=s||o;if(s.nodeType===3||s.nodeType===8){return};if(xe.test(u+t.event.triggered)){return};if(u.indexOf('.')>-1){g=u.split('.');u=g.shift();g.sort()};p=u.indexOf(':')<0&&'on'+u;n=n[t.expando]?n:new t.Event(u,typeof n==='object'&&n);n.isTrigger=l?2:3;n.namespace=g.join('.');n.rnamespace=n.namespace?new RegExp('(^|\\.)'+g.join('\\.(?:.*\\.|)')+'(\\.|$)'):null;n.result=undefined;if(!n.target){n.target=s};a=a==null?[n]:t.makeArray(a,[n]);d=t.event.special[u]||{};if(!l&&d.trigger&&d.trigger.apply(s,a)===!1){return};if(!l&&!d.noBubble&&!S(s)){b=d.delegateType||u;if(!xe.test(b+u)){c=c.parentNode};for(;c;c=c.parentNode){v.push(c);f=c};if(f===(s.ownerDocument||o)){v.push(f.defaultView||f.parentWindow||e)}};y=0;while((c=v[y++])&&!n.isPropagationStopped()){m=c;n.type=y>1?b:d.bindType||u;h=(i.get(c,'events')||Object.create(null))[n.type]&&i.get(c,'handle');if(h){h.apply(c,a)};h=p&&c[p];if(h&&h.apply&&q(c)){n.result=h.apply(c,a);if(n.result===!1){n.preventDefault()}}};n.type=u;if(!l&&!n.isDefaultPrevented()){if((!d._default||d._default.apply(v.pop(),a)===!1)&&q(s)){if(p&&r(s[u])&&!S(s)){f=s[p];if(f){s[p]=null};t.event.triggered=u;if(n.isPropagationStopped()){m.addEventListener(u,ke)};s[u]();if(n.isPropagationStopped()){m.removeEventListener(u,ke)};t.event.triggered=undefined;if(f){s[p]=f}}}};return n.result},simulate:function(e,n,i){var r=t.extend(new t.Event(),i,{type:e,isSimulated:!0});t.event.trigger(r,null,n)}});t.fn.extend({trigger:function(e,n){return this.each(function(){t.event.trigger(e,n,this)})},triggerHandler:function(e,n){var i=this[0];if(i){return t.event.trigger(e,n,i,!0)}}});if(!a.focusin){t.each({focus:'focusin',blur:'focusout'},function(e,n){var r=function(e){t.event.simulate(n,e.target,t.event.fix(e))};t.event.special[n]={setup:function(){var t=this.ownerDocument||this.document||this,o=i.access(t,n);if(!o){t.addEventListener(e,r,!0)};i.access(t,n,(o||0)+1)},teardown:function(){var t=this.ownerDocument||this.document||this,o=i.access(t,n)-1;if(!o){t.removeEventListener(e,r,!0);i.remove(t,n)}
...
else if(!i&&F(n)==='object'){for(o in n){he(e+'['+o+']',n[o],i,r)}}
...
else{n=o}};r=Le.exec(e);s=!i&&[];if(r){return[n.createElement(r[1])]};r=Ze([e],n,s);if(s&&s.length){t(s).remove()};return t.merge([],r.childNodes)};t.fn.load=function(e,n,i){console.log(e);var o,l,u,a=this,s=e.indexOf(' ');if(s>-1){o=x(e.slice(s));e=e.slice(0,s)};if(r(n)){i=n;n=undefined}
else if(n&&typeof n==='object'){l='POST'};if(a.length>0){t.ajax({url:e,type:l||'GET',dataType:'html',data:n}).done(function(e){u=arguments;a.html(o?t('<div>').append(t.parseHTML(e)).find(o):e)}).always(i&&function(e,t){a.each(function(){i.apply(this,u||[e.responseText,t,e])})})};return this};t.expr.pseudos.animated=function(e){return t.grep(t.timers,function(t){return e===t.elem}).length};t.offset={setOffset:function(e,n,i){var s,l,u,c,o,f,h,d=t.css(e,'position'),p=t(e),a={};if(d==='static'){e.style.position='relative'};o=p.offset();u=t.css(e,'top');f=t.css(e,'left');h=(d==='absolute'||d==='fixed')&&(u+f).indexOf('auto')>-1;if(h){s=p.position();c=s.top;l=s.left}
else{c=parseFloat(u)||0;l=parseFloat(f)||0};if(r(n)){n=n.call(e,i,t.extend({},o))};if(n.top!=null){a.top=(n.top-o.top)+c};if(n.left!=null){a.left=(n.left-o.left)+l};if('using' in n){n.using.call(e,a)}
...
else{e.removeClass(t).removeAttr('style')}})}};portunaHelper.twoClickHandle=function(){var t='two_click_enabled',e='|',n=!0;$('.iframe-wrapper-manual-enabling').click(function(){var i=$(this),a=i.children('iframe');i.children('.iframe-label').remove();a.attr('src',a.data('src'));i.children().first().unwrap();if(n===!0&&i.data('enablekey')){var r=i.data('enablekey'),o=portunaHelper.cookie.get(t)||'';if(o.indexOf(e+r+e)===-1){portunaHelper.cookie.set(t,o+e+r+e,60)}};n=!0});$('.iframe-wrapper-manual-enabling').each(function(){var i=$(this);if(i.data('enablekey')){var r=portunaHelper.cookie.get(t)||'';if(i.data('enablekey')&&r.indexOf(e+i.data('enablekey')+e)!==-1){n=!1;i.trigger('click')}}})};Date.prototype.format=portunaHelper.date;$(document).ready(portunaHelper.twoClickHandle);portunaHelper.imageMagnifier=function(e,t,n,i){var c=this,l=!1;$('table img').addClass('tableimage');e=e||'data-scaleable';n=n||!1;i=i||'data-magnifier';if(t!==undefined){l=!0};var s=$('img['+e+']'),o='https://layout.verwaltungsportal.de/global/interaktiv/buttons/',r=(!n)?o+'overlay_search_white_v2.png':'',a=(!n)?o+'overlay_search_magifier.png':'';if(s.length>0){$('#content').prepend($('<img />').css({visibility:'hidden',display:'none'}).attr({'id':'fancyboxOverlayPreload1',src:r,alt:'Suchsymbol'}));$('#content').prepend($('<img />').css({visibility:'hidden',display:'none'}).attr({'id':'fancyboxOverlayPreload2',src:a,alt:'Lupe'}))};var u=function(s){if(t===undefined&&s.parent().is('a')&&s.parent().attr('rel')!==''){t=s.parent().attr('rel')}
else if(t===undefined&&s.parents('.tiny_p').length>0&&s.parents('#content').length>0){t='replacerel'}
else{t='scaleableimage'};var h=Math.floor((Math.random()*185540)+1),g='hoverOverlay'+h,m='magnifierGlass'+h,f=s.attr('height'),u=s.attr('width'),d=s.parent().css('width'),d=d.replace('px','');if(typeof f==='undefined'||!~~f||f==='0px'){f=s.css('height');if(typeof f==='undefined'||!~~f||f==='0px'){f=s.height()+'px'};f=f.replace('px','');s.css({'height':''});s.attr({'height':f})};if(typeof u==='undefined'||!~~u||u==='0px'){u=s.css('width');if(typeof u==='undefined'||!~~u||u==='0px'){u=s.width()+'px'};u=u.replace('px','');s.css({'width':''});s.attr({'width':u})};if((parseInt(d)!=0)&&(parseInt(u)>parseInt(d))){f=d*f/u;u=d;s.attr({'width':u});s.attr({'height':f})};if(typeof f==='undefined'||typeof u==='undefined'){return!0};if((s.attr(i)==='true')&&!n&&(f>=25)&&(u>=25)){r=o+'overlay_search_white_v2.png'}
else{r=''};if(s.parent().is('a')){s.unwrap()};var p='';if(s.parent().css('text-align')==='center'){p='inline-block'}
else{p='block'};s.wrap('<div> </div>');s.parent().attr('style',s.attr('style'));s.parent().css({width:u+'px',height:f+'px',position:'relative',display:p}).addClass('fancyfix');s.wrap('<a rel="'+t+'" href="'+s.attr(e)+'" title="'+s.attr('title').replace(/"/g,'&#34;')+portunaHelper.fancyboxAddition+'"></a>');s.removeAttr('style');s.removeAttr(e);s.removeAttr(i);if(a!==''){background='url("'+a+'") no-repeat scroll center center #FFFFFF'}
else{background='#FFFFFF center center'};s.parent().prepend($('<span />').css({background:background,height:f+'px',position:'absolute',width:u+'px','z-index':'10',opacity:'0'}).attr({'id':g,'class':'hoverOverlayFix'}));if(r!==''){s.parent().append($('<span />').css({padding:'0',position:'absolute',width:'25px',height:'25px',bottom:'0',right:'0'}).attr({'id':m}).append($('<img />').attr({src:r,alt:'Lupe'})))};$('#'+g).on({mouseenter:function(){$(this).stop().animate({opacity:.5},'slow');$(this).siblings('span').stop().animate({opacity:0},'slow')},mouseleave:function(){$(this).stop().animate({opacity:0},'slow');$(this).siblings('span').stop().animate({opacity:1},'slow')}});c.attachFancybox(t);if(!l){t=undefined}};$.each(s,function(){var n=$(this);if(!n.attr(e)){return!0};var t=new Image;t.onload=function(){u(n)};t.onerror=t.onload;t.src=n.attr('src')});this.replaceRel();return this};portunaHelper.replaceRel=function(){$(window).on('load',function(){let siblingElements=$('#content').find('div.fancyfix a[rel]:not([rel="replacerel"])'),replacerel;if(siblingElements.length>0){replacerel=siblingElements.first().attr('rel');if(replacerel===undefined||replacerel===''){replacerel='scaleableimage'}}
else{replacerel='scaleableimage'};$('a[rel="replacerel"]').each(function(){$(this).attr('rel',replacerel)})})};portunaHelper.fancyboxLoaded=!1;portunaHelper.fancyboxAddition=' ';portunaHelper.attachFancybox=function(e){function n(){$('a[rel='+e+']').fancybox({nextEffect:'none',prevEffect:'none',closeBtn:!0,tpl:{error:'<p class="fancybox-error">'+unescape('Die Bildquelle ist nicht verf%FCgbar.')+'</p>'},'titlePosition':'inside','transitionIn':'fade','transitionOut':'fade','titleFormat':function(e,n,i,r){return'<span id="white">'+(t>1?'<small class="page_pointer">Bild '+(i+1)+' von '+n.length+':</small><br /> ':'')+e.replace(portunaHelper.fancyboxAddition,'')+'</span>'}})};e=e||'fancyboxImage';var t=$('a[rel='+e+']').length;if(typeof $.fancybox==='undefined'&&!portunaHelper.fancyboxLoaded&&t>0){portunaHelper.fancyboxLoaded=!0;$.when($.getScript('/js/fancybox/jquery.mousewheel-3.0.6.pack.js'),$.getScript('/js/fancybox/jquery.fancybox-framework.js')).done(function(){if(t>0){n()}
else{portunaHelper.fancyboxLoaded=!1}})}
else if(typeof $.fancybox!=='undefined'&&$.isFunction($.fancybox)&&t>0){n()}
else if(typeof $.fancybox==='undefined'&&portunaHelper.fancyboxLoaded){window.setTimeout(function(){portunaHelper.attachFancybox(e)},500)}};function addBookmark(e,t){e||(e=window.location),t||(t=document.title);var n=navigator.userAgent.toLowerCase();if(window.sidebar)alert('Bitte drücken Sie Strg+D (oder CMD+D für Mac\'s) um diese Seite als Favorit hinzuzufügen.');else if(window.external)-1==n.indexOf('chrome')?window.external.AddFavorite(e,t):alert('Bitte drücken Sie Strg+D (oder CMD+D für Mac\'s) um diese Seite als Favorit hinzuzufügen.');else{if(window.opera&&window.print)return!0;-1!=n.indexOf('konqueror')?alert('Bitte drücken Sie Strg+D (oder CMD+D für Mac\'s) um diese Seite als Favorit hinzuzufügen.'):-1!=n.indexOf('webkit')?alert('Bitte drücken Sie Strg+D (oder CMD+D für Mac\'s) um diese Seite als Favorit hinzuzufügen.'):alert('Ihr Browser unterstützt das Hinzufügen von Favoriten mittels einer Webseite nicht. Bitte fügen Sie den aktuellen Link manuell als Favorit hinzu.')}}(function(e,t,n){'use strict';function r(t,n){var c,f,d,p,u,h,g,m,i,l,v;n=n||{};c=n.multi_month||1;l=n.minDate||null;i=n.maxDate||null;f=n.submit_on_select||!1;d=n.button_only||!1;p=!1;h=n.year_positive||25;g=n.year_negative||25;m='c-'+g+':c+'+h;v=n.global_design_http;if(t instanceof e){u=t}
else{t=t||'formatDate';u='input.'+t+':not(.exclude)'};e(u).each(function(){var u=e(this),M=u.attr('placeholder');u.attr('placeholder','');u.attr('autocomplete','off');var w=e(this).clone(!0).addClass('exclude hasDatepicker'),j=u.prop('id')||'_unknown_id_',D=u.prop('title')||'Wählen Sie ein Datum aus.',S=u.prop('name')||'Datum',t={};if(u.hasClass('hasDatepicker')){return!0};function A(e){var t=e.match(/^((?:\d{2})?(?:\d{2}))-(\d{2})-(\d{2})$/);e=e.split('-');return t?t[3]+'.'+t[2]+'.'+t[1]:e};function N(e){return e.replace(/^(\d{1,2})\.?(\d{1,2})?\.?((?:\d{2})?\d{2})?$/,function(e,t,n,i){var l=new Date(),r=l.getFullYear(),o=l.getMonth()+1,a=l.getDate(),s=(~~(r/100))*100;t.length==1&&(t='0'+t);!n&&(n=o+'')&&(i=r+'');n.length==1&&(n='0'+n);a<10&&(a='0'+a);o<10&&(o='0'+o);return t+'.'+n+'.'+(!i||!i.length?(n+'-'+t<o+'-'+a?r+1:r):(i.length==2?(Math.abs(~~i+s-r)<=Math.abs(~~i+s-100-r)?~~i+s:~~i+s-100):i))})};function T(e){return e&&e.match(/^\d{1,2}\.\d{1,2}\.\d{4}$/)!=null};w.attr({id:'',name:S,title:D,type:'hidden'});u.attr({name:'tmp_'+S,title:D,value:A(w.val())});if('ie'!==a()){u.attr({placeholder:M})};u.after(w);t=e.extend({},r.defaultSettings);n.multilingualism=n.multilingualism||{};t.closeText=n.multilingualism.datepicker_close||t.closeText;t.prevText=n.multilingualism.datepicker_previous||t.prevText;t.nextText=n.multilingualism.datepicker_next||t.nextText;t.currentText=n.multilingualism.weekday_name_today||t.currentText;var E=n.multilingualism.datepicker_title||'Datum wählen',h;for(h in t.monthNames){if(!n.multilingualism['month_name_'+(parseInt(h)+1)+'-1']){continue};t.monthNames[h]=n.multilingualism['month_name_'+(parseInt(h)+1)+'-1']};for(h in t.monthNamesShort){if(!n.multilingualism['month_name_'+(parseInt(h)+1)+'-2']){continue};t.monthNamesShort[h]=n.multilingualism['month_name_'+(parseInt(h)+1)+'-2']};for(h in t.dayNames){if(!n.multilingualism['weekday_name_'+h+'-1']){continue};t.dayNames[h]=n.multilingualism['weekday_name_'+h+'-1']};for(h in t.dayNamesShort){if(!n.multilingualism['weekday_name_'+h+'-2']){continue};t.dayNamesShort[h]=n.multilingualism['weekday_name_'+h+'-2'];t.dayNamesMin[h]=n.multilingualism['weekday_name_'+h+'-2']};var k=new Date(),g={y:k.getFullYear(),m:k.getMonth()+1,d:k.getDate(),day:k.getDay()};var C=function(n){if(!n.length){return!1};var i=!1,r={'-2':'vorgestern','-1':'gestern',0:['heute','h'],1:['morgen','m'],2:'übermorgen'};e.each(r,function(e,t){if(x(n,t)){i=!0;b(F(e));return!1}});if(i){return!0};e.each(t.dayNamesShort,function(e,r){if(x(n,r)||x(n,t.dayNames[e])){i=!0;var o=0;if(e>g.day){o=e-g.day}
else{o=t.dayNamesShort.length-g.day+e};b(F(o));return!1}});if(i){return!0};e.each(t.monthNamesShort,function(e,r){if(e==2){r=[r,'mrz']};if(x(n,r)||x(n,t.monthNames[e])){i=!0;var o=0;if(e>g.m){o=e-g.m}
...
else{e('#minDateError').remove();e('#maxDateError').remove()};e.datepicker._curInst.input.datepicker('setDate',t)};function x(t,n){if(typeof n=='object'||e.isArray(n)){var i=!1;e.each(n,function(e,n){i=x(t,n);return!i});return i};return t&&t.match(new RegExp('^'+n+'$','i'))!=null};function F(e){var n=new Date(g.y,g.m-1,g.d),t=new Date();t.setTime(n.getTime()+~~e*24*60*60*1000);return{y:t.getFullYear(),m:t.getMonth()+1,d:t.getDate()}};function H(e){var n=new Date(g.y,g.m-1,g.d),t=new Date(new Date(n).setMonth(g.m+~~e));return{y:t.getFullYear(),m:t.getMonth()+1,d:t.getDate()}};e.datepicker.setDefaults(e.datepicker.regional['de']=t);var y={changeMonth:!0,changeYear:!0,altField:w,altFormat:'yy-mm-dd',numberOfMonths:c,showButtonPanel:!0,yearRange:m,showOn:'button',constrainInput:p,minDate:l?new Date(l):null,maxDate:i?new Date(i):null,fixFocusIE:!1,onSelect:function(e,t){this.fixFocusIE=!0;if(t.input.val()==''){t.settings['altField'].val('')};t.input.change()},onClose:function(t,n){if(t==''){n.settings['altField'].val(t)};this.fixFocusIE=!1;if(f){};var r=e(this),o='undefined'!==typeof r.attr('required'),i=r.val();C(i)||b(i);if(i&&T(i)||!i&&!o){r.removeClass('form-element-invalid')}
else{r.addClass('form-element-invalid')}},beforeShow:function(e,t){var n='ie'===a()?!this.fixFocusIE:!0;this.fixFocusIE=!1;return n}};if(d){y.showOn='both';y.buttonImage=v+'/global/img/calendar.gif';y.buttonImageOnly=!0;y.buttonText=E;u.on('change',function(){w.val(u.val())})}
...
else{i=n.siblings('.form_error.required_error')};break;default:i=n.next('.form_error.required_error');break};i.slideUp(function(){e(this).remove()})};this.removeNumberErrorMessage=function(t){t.removeClass('form_element_error form_element_num_error').attr('aria-invalid',!1);var n;t.attr('type');n=t.siblings('.form_error.num_error');n.slideUp(function(){e(this).remove()})};this.checkFormValidity=function(n){if(n){var i=!0;e(n).find(':input[required]:visible').each(function(){if(this!==undefined){if(!t.checkFieldValidity(e(this))){i=!1}}});e(n).find(':input[type="number"][min][max]').each(function(){if(this!==undefined){if(!t.checkNumberFieldValidity(e(this))){i=!1}}});if(!i){e('.form_error').slideDown();return!1};return!0};return!1}};t.FormValidator=new n()})(jQuery,window);$(document).ready(function(){window.FormValidator.init({'errorMessage':'Bitte f&uuml;llen Sie dieses Feld aus.','errorRadioMessage':'Bitte w&auml;hlen Sie eine Option aus.','errorCheckboxMessage':'Bitte klicken Sie dieses K&auml;stchen an.','errorNumberMessage':'Bitte geben Sie eine Zahl zwischen %min% und %max% an.'})});$('*').on('click',function(){return!0});$(document).ready(function(){$('.share_button_wrapper_0').on('mouseover touchstart',function(){$(this).css('background-color','#FFFFFF')}).on('mouseout touchend',function(){$(this).css('background-color','#FFFFFF')});$('.share_button_wrapper_0 > a').on('focusin',function(){$(this).parents('.share_button_wrapper_0').css('background-color','#FFFFFF')}).on('focusout',function(){$(this).parents('.share_button_wrapper_0').css('background-color','#FFFFFF')});$('.share_button_wrapper_1').on('mouseover touchstart',function(){$(this).css('background-color','#FFFFFF')}).on('mouseout touchend',function(){$(this).css('background-color','#FFFFFF')});$('.share_button_wrapper_1 > a').on('focusin',function(){$(this).parents('.share_button_wrapper_1').css('background-color','#FFFFFF')}).on('focusout',function(){$(this).parents('.share_button_wrapper_1').css('background-color','#FFFFFF')});$('.share_button_wrapper_2').on('mouseover touchstart',function(){$(this).find('i').css('color','#ec6e29');$(this).css('background-color','#FFFFFF')}).on('mouseout touchend',function(){$(this).find('i').css('color','#595959');$(this).css('background-color','#FFFFFF')});$('.share_button_wrapper_2 > a').on('focusin',function(){$(this).parents('.share_button_wrapper_2').find('i').css('color','#ec6e29');$(this).parents('.share_button_wrapper_2').css('background-color','#FFFFFF')}).on('focusout',function(){$(this).parents('.share_button_wrapper_2').find('i').css('color','#595959');$(this).parents('.share_button_wrapper_2').css('background-color','#FFFFFF')});$('.share_button_wrapper_3').on('mouseover touchstart',function(){$(this).find('i').css('color','#222222');$(this).css('background-color','#FFFFFF')}).on('mouseout touchend',function(){$(this).find('i').css('color','#595959');$(this).css('background-color','#FFFFFF')});$('.share_button_wrapper_3 > a').on('focusin',function(){$(this).parents('.share_button_wrapper_3').find('i').css('color','#222222');$(this).parents('.share_button_wrapper_3').css('background-color','#FFFFFF')}).on('focusout',function(){$(this).parents('.share_button_wrapper_3').find('i').css('color','#595959');$(this).parents('.share_button_wrapper_3').css('background-color','#FFFFFF')})});function checkVisibilityTopLevel(e){if($('ul',e).length){var t=$('ul:first',e),i=t.clone().appendTo(e).addClass('removeAfter').css('display','block').css('visibility','hidden'),r=t.width(),n=$(window).width(),o=i.offset().left+r<=n;$('.removeAfter').remove();if(!o&&n>=760){$(e).addClass('dropdownedge');$(e).find('ul').css('left','auto').css('right','0')}}};function checkVisibilitySecondLevel(e){if($(e).parent().find('ul').length){var i=$(e).parent().parent().hasClass('dropdownedge'),t=$(e).parent().find('ul:first').addClass('dropdownhelper'),n=t.outerWidth(!0),r=$(window).width(),o=i?n*2:n,a=t.offset().left+o<=r;if(!a){t.css('left',-n);t.css('right','unset')};t.removeClass('dropdownhelper')}};$(document).ready(function(){$('#maindiv').styleSwitcher({directory:'https://layout.verwaltungsportal.de/9167/css/',preview:!1,cookieExpires:1})});$(document).ready(function(){$('meta[name="viewport"]').remove()});function openIcsPopUp(e){var n=makeid(),i=$('h1').text(),t='/veranstaltungen/ics/1/nummer/'+e.rubrik+'/ort/'+e.layer+'/veranstaltungen'+n+'.ics';$('<div/>',{id:'icsPopUp',class:'info_popup_wrapper',}).append($('<div/>',{class:'info_content',role:'alert'}).append($('<div/>',{class:'info_close_wrapper',}).append($('<a/>',{class:'info_close_icon',onclick:'closeIcsPopUp()',title:'Fenster schließen'}).append($('<span/>',{html:'Fenster schließen'})))).append($('<div/>',{class:'info_page_content',html:'<h1>'+i+'</h1><span>Veranstaltung jetzt abonnieren!</span><div id="ics_buttons"><div id="initial_ics"><a target="_blank" title="Zum abonnieren in Outlook (öffnet neues Fenster)" href="webcal://solwodi.de'+t+'">Outlook</a><a target="_blank" title="Zum abonnieren im Google-Kalender (öffnet neues Fenster)" href="https://www.google.com/calendar/render?cid=https://www.solwodi.de'+t+'">Google Calendar</a><a href="#" onclick="icsShowMore(); return false;" id="more_ics_link" title="Weitere Formate anzeigen">weitere Formate</a></div><div id="more_ics"><a target="_top" title="Zum abonnieren in iOS (öffnet neues Fenster)" href="webcal://solwodi.de'+t+'">iOS</a><a href="#" target="_blank" title="Zum abonnieren in Android (öffnet neues Fenster)" onclick="showAndroid(); return false;">Android</a><a target="_blank" title="Zum abonnieren in Live (öffnet neues Fenster)" href="http://calendar.live.com/calendar/calendar.aspx?rru=addsubscription&amp;name=https://www.solwodi.de'+t+'">Live</a><a href="#" title="Zum abonnieren in anderen Programmen (öffnet neues Fenster)" onclick="showOthersIcs(); return false;">Sonstige</a><a href="#" onclick="icsShowLess(); return false;" id="ics_back" title="Zurück zu den anderen Formaten">zurück</a></div><div id="android_ics">Nutzen Sie entweder das Abonnieren über den Google Calendar oder eine alternative Kalender-App und binden dort folgende Adresse ein:<br/><input type="text" readonly="" value="https://www.solwodi.de'+t+'"><a href="#" onclick="icsShowMore(); return false;" id="ics_back" title="Zurück zu den anderen Formaten">zurück</a></div><div id="other_ics">Binden sie in ihrem gewünschten Programm folgende Adresse ein:<br/><input type="text" readonly="" value="https://www.solwodi.de'+t+'"><a href="#" onclick="icsShowMore(); return false;" id="ics_back" title="Zurück zu den anderen Formaten">zurück</a></div></div><div id="download_ics"><a href="https://www.solwodi.de'+t+'" target="_blank" title="Zum herunterladen der ics-Datei"><span>ics-Datei Download</span></a></div>'}))).appendTo('body')};function makeid(){var i=15,t='',n='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789',r=n.length;for(var e=0;e<i;e++){t+=n.charAt(Math.floor(Math.random()*r))};return t};function closeIcsPopUp(){$('#icsPopUp').remove()};function icsShowMore(){$('#initial_ics').hide();$('#android_ics').hide();$('#other_ics').hide();$('#more_ics').show()};function icsShowLess(){$('#more_ics').hide();$('#android_ics').hide();$('#other_ics').hide();$('#initial_ics').show()};function showAndroid(){$('#more_ics').hide();$('#initial_ics').hide();$('#android_ics').show()};function showOthersIcs(){$('#more_ics').hide();$('#initial_ics').hide();$('#other_ics').show()};if(typeof setAtReplacer==='function'){setAtReplacer('@')};!function(){if(!window.hasCookieConsent){window.hasCookieConsent=!0;var s='cookieconsent_options',l='update_cookieconsent_options',t='cookieconsent',u='/js/cookieplugin/',n='cookieconsentTimestamp';cookieHelper.deleteCookie('cookieconsent_dismissed');'function'!=typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,'')});var r,e={isArray:function(e){var t=Object.prototype.toString.call(e);return'[object Array]'==t},isObject:function(e){return'[object Object]'==Object.prototype.toString.call(e)},each:function(t,n,i,r){if(e.isObject(t)&&!r){for(var a in t){t.hasOwnProperty(a)&&n.call(i,t[a],a,t)}}
else{for(var o=0,s=t.length;s>o;o++){n.call(i,t[o],o,t)}}},merge:function(t,n){t&&e.each(n,function(n,i){e.isObject(n)&&e.isObject(t[i])?e.merge(t[i],n):t[i]=n})},bind:function(e,t){return function(){return e.apply(t,arguments)}},queryObject:function(e,t){var i,r=0,n=e;for(t=t.split('.');(i=t[r++])&&n.hasOwnProperty(i)&&(n=n[i]);){if(r===t.length){return n}};return null},setCookie:function(e,t,n){var i=new Date;n=n||7,i.setDate(i.getDate()+n),document.cookie=e+'='+t+'; expires='+i.toUTCString()+'; path=/'},addEventListener:function(e,t,n){e.addEventListener?e.addEventListener(t,n):e.attachEvent('on'+t,n)}},a=function(){var i='data-cc-event',r='data-cc-if',t=function(n,i,r){return e.isArray(i)?e.each(i,function(e){t(n,e,r)}):void(n.addEventListener?n.addEventListener(i,r):n.attachEvent('on'+i,r))},o=function(t,n){return t.replace(/\{\{(.*?)\}\}/g,function(t,i){for(var r,o=i.split('||');token=o.shift();){if(token=token.trim(),'"'===token[0]){return token.slice(1,token.length-1)};if(r=e.queryObject(n,token)){return r}};return''})},a=function(e){var t=document.createElement('div');return t.innerHTML=e,t.children[0]},n=function(t,n,i){var r=t.parentNode.querySelectorAll('['+n+']');e.each(r,function(e){var t=e.getAttribute(n);i(e,t)},window,!0)},s=function(r,o){n(r,i,function(n,i){var r=i.split(':'),a=e.queryObject(o,r[1]);t(n,r[0],e.bind(a,o))})},l=function(t,i){n(t,r,function(t,n){var r=e.queryObject(i,n);r||t.parentNode.removeChild(t)})};return{build:function(t,n){e.isArray(t)&&(t=t.join('')),t=o(t,n);var i=a(t);return s(i,n),l(i,n),i}}}(),i={options:{message:'Diese Website nutzt Cookies, um bestm&ouml;gliche Funktionalit&auml;t bieten zu k&ouml;nnen. ',dismiss:'Alle Cookies akzeptieren',confirm:'Cookie-Auswahl bestätigen',decline:'Nicht notwendige Cookies ablehnen',declineactive:'0',link:null,container:null,buttonbgcolor:'aaaaaa',fontcolor:'000000',buttondeclinecolor:'aaaaaa',declinefontcolor:'000000',buttonbgcolorselected:'aaaaaa',fontcolorselected:'000000',cookielifespan:365,theme:'light-floating',confirmlink:'#null',confirmccevent:'data-cc-event="click:confirm"',markup:['<div class="cc_banner-wrapper {{containerClasses}}" role="dialog" data-nosnippet>','<div class="cc_banner cc_container cc_container--open">','<p class="cc_message">{{options.message}}</p>','<div id="cookie-buttons-div"><a href="#null" data-cc-event="click:dismiss" class="cc_btn cc_btn_accept_all" id="cc_btn_accept_all" style="background: #{{options.buttonbgcolor}};border: 2px solid #{{options.buttonbgcolor}};color: #{{options.fontcolor}} {{options.button_shadow}}">{{options.dismiss}}</a><a href="{{options.confirmlink}}" {{options.confirmccevent}} class="cc_btn cc_btn_confirm" id="cc_btn_confirm" style="background: #{{options.buttonbgcolorselected}};border: 2px solid #{{options.buttonbgcolorselected}};color: #{{options.fontcolorselected}} {{options.button_shadow_selected}}">{{options.confirm}}</a><a href="#null" data-cc-event="click:decline" class="cc_btn cc_btn_decline" id="cc_btn_decline" style="background: #{{options.buttondeclinecolor}};border: 2px solid #{{options.buttondeclinecolor}};color: #{{options.declinefontcolor}} {{options.button_decline_shadow}}">{{options.decline}}</a></div>','</div>','</div>']},init:function(){if(window.location.pathname!=='/datenschutz/index.php'&&window.location.pathname!=='/impressum/index.php'&&window.location.pathname!=='/cookie/settings.html'&&window.location.pathname!=='/m/datenschutz/index.php'&&window.location.pathname!=='/m/impressum/index.php'&&window.location.pathname!=='/m/cookie/settings.html'){var e=window[s];this.setOptions(e);var i=new Date(this.options.timestamp).getTime(),r=cookieHelper.getCookie(n);if(i>r||!(document.cookie.indexOf(t)>-1)||document.cookie.indexOf('cookieconsent_dismissed')>-1){e&&this.setOptions(e),this.setContainer(),this.options.theme?this.loadTheme(this.render):this.render()}}},setOptionsOnTheFly:function(e){this.setOptions(e),this.render()},setOptions:function(t){e.merge(this.options,t)},setContainer:function(){this.container=this.options.container?document.querySelector(this.options.container):document.body,this.containerClasses='',navigator.appVersion.indexOf('MSIE 8')>-1&&(this.containerClasses+=' cc_ie8')},loadTheme:function(t){var i=this.options.theme;-1===i.indexOf('.css')&&(i=u+i+'.css?v=7');var n=document.createElement('link');n.rel='stylesheet',n.type='text/css',n.href=i;var r=!1;n.onload=e.bind(function(){!r&&t&&(t.call(this),r=!0)},this),document.getElementsByTagName('head')[0].appendChild(n)},render:function(){this.element&&this.element.parentNode&&(this.element.parentNode.removeChild(this.element),delete this.element),this.element=a.build(this.options.markup,this),this.container.firstChild?this.container.insertBefore(this.element,this.container.lastChild):this.container.appendChild(this.element);if(this.options.declineactive==='1'){$('#cc_btn_decline').show()}
else{$('#cc_btn_decline').hide()}},dismiss:function(e){e.preventDefault&&e.preventDefault(),e.returnValue=!1,this.setDismissedCookie(),this.container.removeChild(this.element)},setDismissedCookie:function(){e.setCookie(t,['technical','statistic','comfort'],this.options.cookielifespan);e.setCookie(n,[new Date($.now()).getTime()],this.options.cookielifespan);if(navigator.cookieEnabled){location.reload()}},decline:function(e){e.preventDefault&&e.preventDefault(),e.returnValue=!1,this.setDeclineCookie(),this.container.removeChild(this.element)},setDeclineCookie:function(){e.setCookie(t,['technical'],this.options.cookielifespan);e.setCookie(n,[new Date($.now()).getTime()],this.options.cookielifespan);if(navigator.cookieEnabled){location.reload()}},confirm:function(e){var t='technical';if($('input[name=\'statistic\']').is(':checked')){t+=',statistic'};if($('input[name=\'comfort\']').is(':checked')){t+=',comfort'};e.preventDefault&&e.preventDefault(),e.returnValue=!1,this.setConfirmCookie(t),this.container.removeChild(this.element)},setConfirmCookie:function(i){e.setCookie(t,i,this.options.cookielifespan);e.setCookie(n,[new Date($.now()).getTime()],this.options.cookielifespan);if(navigator.cookieEnabled){location.reload()}}},o=!1;(r=function(){o||'complete'!=document.readyState||(i.init(),o=!0,window[l]=e.bind(i.setOptionsOnTheFly,i))})(),e.addEventListener(document,'readystatechange',r)}}();$(window).on('unload',function(){});window.cookieconsent_options={message:'<h2>Cookie-Einstellungen<\/h2>Wir verwenden Cookies, um Ihnen ein optimales Webseiten-Erlebnis zu bieten. Dazu z\u00e4hlen Cookies, die f\u00fcr den Betrieb der Seite notwendig sind, sowie solche, die lediglich zu anonymen Statistikzwecken, f\u00fcr Komforteinstellungen oder zur Anzeige personalisierter Inhalte genutzt werden. Sie k\u00f6nnen selbst entscheiden, welche Kategorien Sie zulassen m\u00f6chten. Bitte beachten Sie, dass auf Basis Ihrer Einstellungen wom\u00f6glich nicht mehr alle Funktionalit\u00e4ten der Seite zur Verf\u00fcgung stehen. <br\/>Sie k\u00f6nnen Ihre Auswahl jederzeit unter den Cookie-Einstellungen in der Datenschutzerkl\u00e4rung anpassen.<br\/><span id="imprint-cookie-link"><a href="\/impressum\/index.php" target="_blank">Impressum<\/a><\/span><span id="privacy-cookie-link"><a href="\/datenschutz\/index.php" target="_blank">Datenschutzerkl&auml;rung<\/a><\/span><br\/>\n                <div id="cc_options"> \n                <label for="technical">\n                    <input id="technical" type="checkbox" name="technical" checked="checked" disabled>\n                    Notwendig\n                <\/label>\n                <label for="comfort">\n                    <input id="comfort" type="checkbox" name="comfort" >\n                    Komfort\n                <\/label>\n                <label for="statistic">\n                    <input id="statistic" type="checkbox" name="statistic" >\n                    Statistik\n                <\/label>\n                <\/div>\n<style>\n#cookie-toggle-details:not(.toggled) > span:last-child {\n    display: none\n}\n#cookie-toggle-details.toggled > span:first-child {\n    display: none\n}\n<\/style>\n<div id="cookie-toggle-details" tabindex="0" aria-controls="cookie-details"><span>Details anzeigen<\/span><span>Details ausblenden<\/span><\/div><div id="cookie-details" aria-expanded="false"><\/br><div>\n    <u>Notwendig:<\/u>\n    <br><br>\n    <table class="cookie_table" style="width: 98%; border: 1px dotted rgba(0,0,0,0.2);">\n        <colgroup>\n            <col style="width: 21%;">\n            <col style="width: auto;">\n            <col style="width: 20%;">\n        <\/colgroup>\n        <tbody><tr>\n            <th scope="col" >Name<\/th>\n            <th scope="col" >Zweck<\/th>\n            <th scope="col" >Laufzeit<\/th>\n        <\/tr>            \n        <tr>\n            <td>cookieconsent<\/td>\n            <td>Speichert, welche Cookie-Einstellungen Sie akzeptiert haben.<\/td>\n            <td>365 Tage<\/td>\n        <\/tr>\n        <tr>\n            <td>cookieconsentTimestamp<\/td>\n            <td>Speichert, wann Sie die Cookie-Einstellungen akzeptiert haben.<\/td>\n            <td>365 Tage<\/td>\n        <\/tr>\n                <tr>\n        <td>navigation<\/td>\n        <td>Speichert das zuletzt genutzte Untermen&uuml;, um dies beim n&auml;chsten Seitenladen zu markieren und ggf. Men&uuml;bezogene Einstellungen zu laden.<\/td>\n        <td>10 Minuten<\/td>\n    <\/tr>    <tr>\n        <td>navigation2<\/td>\n        <td>Speichert das zuletzt genutzte Untermen&uuml;, um dies beim n&auml;chsten Seitenladen zu markieren und ggf. men&uuml;-bezogene Einstellungen zu laden.<\/td>\n        <td>10 Minuten<\/td>\n    <\/tr>    <tr>\n        <td>browserupdateorg<\/td>\n        <td>Speichert, ob Sie den Hinweis &uuml;ber einen veralteten Browser ausgeblendet haben.<\/td>\n        <td>eine Stunde<\/td>\n    <\/tr>    <tr>\n        <td>IpCaptcha<\/td>\n        <td>Speichert den Nachweis, dass bei einem ungew&ouml;hnlichen Nutzerverhalten ein Captcha gel&ouml;st wurde, um die Seite wieder aufrufen zu k&ouml;nnen.<\/td>\n        <td>ein Tag<\/td>\n    <\/tr>    <tr>\n        <td>PHPSESSID<\/td>\n        <td>Speichert die Konfiguration der Nutzerparameter &uuml;ber die Seitenaufrufe hinaus.<\/td>\n        <td>eine Stunde \/ Sitzungsende bei Logins<\/td>\n    <\/tr>    <tr>\n        <td>lang<\/td>\n        <td>Speichert die aktuell gew&auml;hlte Sprache.<\/td>\n        <td>eine Stunde<\/td>\n    <\/tr>    <tr>\n        <td><\/td>\n        <td><\/td>\n        <td><\/td>\n    <\/tr><\/tbody><\/table><br>\n    <br><u>Komfort:<\/u>\n    <br><br>\n    <table class="cookie_table" style="width: 98%; border: 1px dotted rgba(0,0,0,0.2);">\n        <colgroup>\n            <col style="width: 21%;">\n            <col style="width: auto;">\n            <col style="width: 20%;">\n        <\/colgroup>\n        <tbody><tr>\n            <th scope="col" >Name<\/th>\n            <th scope="col" >Zweck<\/th>\n            <th scope="col" >Laufzeit<\/th>\n        <\/tr>    <tr>\n        <td>activetop<\/td>\n        <td>Speichert den zuletzt genutzten Hauptmen&uuml;punkt, um diesen beim n&auml;chsten Seitenladen zu markieren und ggf. men&uuml;-bezogene Einstellungen zu laden.<\/td>\n        <td>10 Minuten<\/td>\n    <\/tr>    <tr>\n        <td>activesecond<\/td>\n        <td>Speichert den zuletzt genutzten Untermen&uuml;punkt, um diesen beim n&auml;chsten Seitenladen zu markieren und ggf. men&uuml;-bezogene Einstellungen zu laden.<\/td>\n        <td>10 Minuten<\/td>\n    <\/tr>    <tr>\n        <td>activethird<\/td>\n        <td>Speichert den zuletzt genutzten Unteruntermen&uuml;punkt, um diesen beim n&auml;chsten Seitenladen zu markieren und ggf. men&uuml;-bezogene Einstellungen zu laden.<\/td>\n        <td>10 Minuten<\/td>\n    <\/tr>    <tr>\n        <td>style_selected<\/td>\n        <td>Speichert die aktuell ausgew&auml;hlte Schriftgr&ouml;&szlig;e.<\/td>\n        <td>eine Stunde<\/td>\n    <\/tr>    <tr>\n        <td>NID<\/td>\n        <td>Nutzt der ReCaptcha bei Sicherheitsabfragen um den Benutzer zu identifizieren.<\/td>\n        <td>6 Monate<\/td>\n    <\/tr> \n        <\/tbody><\/table>\n           \n    <br>\n    <br><u>Statistik:<\/u>\n    <br><br>\n    <table class="cookie_table" style="width: 98%; border: 1px dotted rgba(0,0,0,0.2);">\n        <colgroup>\n            <col style="width: 21%;">\n            <col style="width: auto;">\n            <col style="width: 20%;">\n        <\/colgroup>\n        <tbody><tr>\n            <th scope="col" >Name<\/th>\n            <th scope="col" >Zweck<\/th>\n            <th scope="col" >Laufzeit<\/th>\n        <\/tr>    <tr>\n        <td>_pk_id<\/td>\n        <td>Speichert eine eindeutige Id, um die Webseitennutzung des Nutzers zu analysieren.<\/td>\n        <td>56 Wochen<\/td>\n    <\/tr>    <tr>\n        <td>_pk_ses<\/td>\n        <td>Speichert eine eindeutige Id der Sitzung des Nutzers.<\/td>\n        <td>30 Minuten<\/td>\n    <\/tr>\n        <\/tbody><\/table><\/div><\/div>',buttonbgcolor:'5B821C',fontcolor:'ffffff',buttonbgcolorselected:'ffffff',fontcolorselected:'545454',button_shadow:'',button_shadow_selected:'',button_decline_shadow:'',confirm:'Cookie-Auswahl bestätigen',dismiss:'Alle Cookies akzeptieren',decline:'Nicht notwendige Cookies ablehnen',declineactive:'0',buttondeclinecolor:'ffffff',declinefontcolor:'545454',cookielifespan:365,timestamp:'2021-11-16 10:06:27',theme:'consent-new2',isConsent:!0,stylerType:'comfort',contrastType:'comfort'};cookieHelper.options.isConsent=!0;(function(e,t,n){function i(){this.callbacks={};this.options={};this.linkTitleExtend={'de':'(öffnet neues Fenster)','en':'(opens new window)'};var t=this;this.init=function(e){if(e.extern_link_text_text){t.linkTitleExtend[e.lang]=e.extern_link_text_text};for(var n in e){if(n!=='lang'&&n!=='fancybox_addition_text'){e[n]=parseInt(e[n])}};t.options=e;t.initHandlers().initAccessibility();return t};this.initHandlers=function(){t.accordeonHandler();t.triggerCollapseHandler();e(document).on('keypress',function(n){if(n.which===13){var i=e(':focus'),r=i.data('focus');if(r&&t.callbacks[r]){t.callbacks[r](i)}
